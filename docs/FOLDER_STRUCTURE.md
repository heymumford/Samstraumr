...
- `JAVA_NAMING_STANDARDS.md`: Java naming conventions
- `LOGGING_STANDARDS.md`: Logging conventions and standards
...
| `util/test/` | Test execution utilities | `run-tests.sh`, `run-atl-tests.sh` |
