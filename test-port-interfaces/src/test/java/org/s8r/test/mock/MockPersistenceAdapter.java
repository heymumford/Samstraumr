...
/**
 * Mock implementation of the PersistencePort interface for testing.
 *
 * <p>This implementation provides a thread-safe in-memory storage for testing
 * the PersistencePort interface functionality.
 */
public class MockPersistenceAdapter implements PersistencePort {
    ...
    /**
     * Constructs a new MockPersistenceAdapter.
     *
     * @param logger The logger to use
     */
    public MockPersistenceAdapter(LoggerPort logger) {
        this.logger = logger;
    ...
    /**
     * Gets the internal storage for testing purposes.
     *
     * @return The internal storage
     */
    public Map<String, Map<String, Map<String, Object>>> getInternalStorage() {
        return storage;
    }
}