...
public class EventPublisherPortSteps {
    ...
    public void iPublishAnEventToTopicWithTypeAndPayload(String topic, String eventType, String payload) {
    ...
    public void theSubscriberShouldReceiveTheEvent() {
        Assertions.assertTrue(currentSubscriber.wasEventReceived(), "Subscriber should receive the event");
    }
    ...
    public void theSubscriberShouldReceiveTheEventWithProperties(DataTable dataTable) {
        ...
        Assertions.assertTrue(allPropertiesMatch, "An event with all expected properties should be received");
    }
    ...
    public void iPublishAnotherEventToTheSameTopic() {
        ...
        // Publish a new event
        publishResult = eventPublisher.publishEvent("subscribe-test", "another-event", "Another test payload");
    }
    
    @Then("the subscriber should not receive the second event")
    public void theSubscriberShouldNotReceiveTheSecondEvent() {
        Assertions.assertFalse(currentSubscriber.wasEventReceived(), 
    ...
    public void allSubscribersShouldReceiveTheEvent() {
        for (Map.Entry<String, TestEventSubscriber> entry : topicSubscribers.entrySet()) {
            ...
            Assertions.assertTrue(subscriber.wasEventReceived(), 
    ...
    public void eachSubscriberShouldReceiveOnlyEventsForItsTopic() {
        for (Map.Entry<String, TestEventSubscriber> entry : topicSubscribers.entrySet()) {
            ...
            for (Map<String, Object> event : events) {
                Assertions.assertEquals(topic, event.get("topic"), 
