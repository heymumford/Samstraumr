...
Feature: Component Lifecycle Management
  ...
  @ATL @L0_Core @Lifecycle @Progression
  ...
  @ATL @L0_Core @Lifecycle @StateBehavior
  ...
  @ATL @L0_Core @Lifecycle @ResourceManagement
  ...
  @ATL @L0_Core @Lifecycle @StateMetadata
  ...
  @ATL @L0_Core @Lifecycle @InvalidTransitions
