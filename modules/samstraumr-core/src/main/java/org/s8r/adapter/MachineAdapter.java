...
public class MachineAdapter {
  ...
  /**
   * Creates a MachinePort interface from a Machine implementation. This is a factory method that
   * provides access to the adapter while keeping the adapter class itself private.
   *
      ...
      try {
        ...
        if (composite instanceof ComponentAdapter.CompositeComponentAdapter) {
          ...
          org.s8r.component.Composite componentComposite =
              new org.s8r.component.Composite(
  ...
  private static class MachineToDomainPortAdapter implements MachinePort {
    ...
    public boolean addComposite(String name, CompositeComponentPort composite) {
      ...
      if (composite instanceof org.s8r.adapter.ComponentAdapter.CompositeComponentAdapter) {
        ...
        org.s8r.domain.component.composite.CompositeComponent domainComposite =
            ((org.s8r.adapter.ComponentAdapter.CompositeComponentAdapter) composite)
    ...
    public Map<String, CompositeComponentPort> getComposites() {
      ...
      for (org.s8r.domain.component.composite.CompositeComponent component : components) {
        ...
        ports.put(
            idString, org.s8r.adapter.ComponentAdapter.createCompositeComponentPort(component));
      }
    ...
    public boolean addComponent(
        String name, org.s8r.domain.component.port.ComponentPort component) {
      // Not supported at this level, components are added to composites, not machines
      return false;
    }

    @Override
    public java.util.Optional<org.s8r.domain.component.port.ComponentPort> removeComponent(
        String name) {
  ...
  private static class ComponentToPortAdapter
      implements org.s8r.domain.component.port.ComponentPort {
