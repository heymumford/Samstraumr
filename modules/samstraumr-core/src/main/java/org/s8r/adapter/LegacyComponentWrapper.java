...
/**
 * A wrapper that implements the Clean Architecture Component interface by delegating to a legacy
 * component.
 *
 * <p>This wrapper maintains the interface contract of the new Component type while using an
 * underlying legacy component for actual implementation. This supports a smooth transition path for
 * legacy code while maintaining clean architecture principles.
 *
 ...
 * implementation. This follows the Dependency Inversion Principle by making both the wrapper and
 * its clients depend on abstractions rather than concrete implementations.
 */
public class LegacyComponentWrapper extends Component implements ComponentPort {
  ...
  public String toString() {
    return "LegacyComponentWrapper{id="
        + getId()
        + ", type="
        + legacyType
        + ", state="
