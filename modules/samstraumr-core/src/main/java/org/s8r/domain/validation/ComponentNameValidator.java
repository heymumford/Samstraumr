...
/**
 * Utility class for validating component names.
 * Ensures that component names meet specific criteria for length and character content.
 */
    ...
    public static void validateComponentName(String name) {
        ...
        if (name == null) {
            throw new InvalidComponentNameException(
                ...
                "null",
                "Component name must be non-null"
            );
        }
