...
/**
 * Represents the specific operational modes a tube can adopt within its
 * chosen survival strategy.
 */
public enum StrategyMode {
     ...
     */
    public static StrategyMode forStrategy(SurvivalStrategy strategy, 
