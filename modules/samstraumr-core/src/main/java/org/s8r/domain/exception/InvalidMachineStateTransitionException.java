...
/**
 * Exception thrown when an invalid machine state transition is attempted.
 * This exception provides detailed information about the attempted transition
 * and which states are valid for a specific operation.
 */
public class InvalidMachineStateTransitionException extends ComponentException {
    ...
    public InvalidMachineStateTransitionException(
        ...
        super(String.format("Invalid machine state transition from %s to %s for machine %s", 
    ...
    /**
     * Creates a new InvalidMachineStateTransitionException for an operation requiring specific states.
     *
     * @param machineId The ID of the machine
    ...
    private static String buildMessage(
        ...
        message.append(String.format("Cannot perform operation '%s' on machine %s in state %s. ", 
