...
/**
 * Exception thrown when an operation refers to a component that doesn't exist in the current context.
 * 
...
public class NonExistentComponentReferenceException extends ComponentException {
     ...
     *
     * @param operationType The type of operation that attempted to reference the non-existent component
    ...
    public NonExistentComponentReferenceException(
        ...
        super(String.format(
                ...
                operationType,
                referringComponentId.getShortId(), 
                referencedComponentId.getShortId()));
