 ...
 *
 * <p>This interface extends the CompositeComponentPort with operations specific to machines, which
 * are orchestrating components that manage composites and their behavior.
 */
