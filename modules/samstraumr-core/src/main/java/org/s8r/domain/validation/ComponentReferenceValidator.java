 ...
 *
 * <p>This class provides methods to check if component references are valid, throwing appropriate
 * exceptions when they're not.
 */
public class ComponentReferenceValidator {
  ...
  public static void validateComponentReference(
    ...
    if (!exists) {
      throw new NonExistentComponentReferenceException(
          operationType, referringComponentId, referencedComponentId);
    }
  }
  ...
  public static void validateComponentReferences(
    ...
    for (ComponentId referencedId : referencedComponentIds) {
      validateComponentReference(operationType, referringComponentId, referencedId, existsFunction);
    }
  }
}
