...
/**
 * Exception thrown when a connection would create a cycle in a component hierarchy.
 * This prevents infinite recursion and ensures a valid directed acyclic graph structure.
 */
public class ConnectionCycleException extends ComponentException {
     ...
     */
    public ConnectionCycleException(String message, ComponentId sourceId, ComponentId targetId, List<ComponentId> cyclePath) {
        super(message);
