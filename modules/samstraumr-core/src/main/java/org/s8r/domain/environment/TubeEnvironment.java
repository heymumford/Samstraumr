...
/**
 * Represents the environment in which a tube exists, including various
 * environmental factors that influence tube behavior and decisions.
 */
public class TubeEnvironment {
    ...
    public void addFactor(EnvironmentalFactor factor) {
        ...
        LOGGER.fine("Added environmental factor: " + factor.getName() + 
                " with value: " + factor.getValue() + 
                " and classification: " + factor.getClassification());
    }
    ...
    public void updateFactor(EnvironmentalFactor factor) {
        if (factors.containsKey(factor.getName())) {
            factors.put(factor.getName(), factor);
            LOGGER.fine("Updated environmental factor: " + factor.getName() + 
                    " with value: " + factor.getValue() + 
                    " and classification: " + factor.getClassification());
        } else {
            addFactor(factor);
    ...
    public String getSummary() {
        ...
        summary.append("] - Overall Favorability: ")
