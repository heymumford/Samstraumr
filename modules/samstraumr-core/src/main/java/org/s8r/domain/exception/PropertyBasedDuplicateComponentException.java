...
/**
 * Exception thrown when components are identified as potential duplicates based on property
 * analysis.
 *
...
public class PropertyBasedDuplicateComponentException extends DuplicateComponentException {
  ...
  /**
   * Creates a new PropertyBasedDuplicateComponentException with detailed information about the
   * duplicate.
   *
  ...
  public PropertyBasedDuplicateComponentException(
    ...
    super(
        buildMessage(newComponentId, existingComponentId, duplicateProperties, duplicateReason),
        newComponentId);
  ...
  /**
   * Creates a new PropertyBasedDuplicateComponentException with information derived from component
   * analysis.
   *
