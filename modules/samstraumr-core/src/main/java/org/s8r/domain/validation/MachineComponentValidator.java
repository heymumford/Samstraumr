 ...
 *
 * <p>This class provides methods to ensure that components added to machines exist and meet the
 * requirements for being part of a machine.
 */
public class MachineComponentValidator {
  ...
  public static void validateComponentExists(
    ...
    ComponentReferenceValidator.validateComponentReference(
        "addComponent", machineId, componentId, existsFunction);
  }
   ...
   */
  public static void validateIsCompositeComponent(ComponentId machineId, Object component) {
    ...
    if (!(component instanceof CompositeComponent)) {
      ...
      throw new InvalidCompositeTypeException(machineId, component.getClass().getName());
    }
  }
   ...
   */
  public static void validateMachineComponents(Machine machine, CompositeComponent... components) {
