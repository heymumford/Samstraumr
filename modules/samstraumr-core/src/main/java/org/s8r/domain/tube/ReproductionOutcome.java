...
/**
 * Represents the outcome of a tube reproduction attempt, including
 * the environmental conditions, strategy used, and success rate.
 */
public class ReproductionOutcome {
     ...
     */
    public ReproductionOutcome(int attempt, String environmentalConditions, 
            String strategy, String outcome, double successRate) {
