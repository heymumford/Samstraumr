 ...
 * They can be used to trigger side effects, implement the Observer pattern, or facilitate eventual
...
public abstract class DomainEvent {
  ...
  /**
   * Sets whether this event originated from a port interface. This helps adapters track events that
   * came from port interfaces vs. concrete implementations, facilitating Clean Architecture.
   *
