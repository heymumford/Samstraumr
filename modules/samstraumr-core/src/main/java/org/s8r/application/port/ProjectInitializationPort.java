 ...
 *
 * <p>This interface defines the operations required to initialize a Samstraumr project, following
 * the Ports and Adapters pattern from Clean Architecture. It allows the application layer to
 * coordinate project initialization without depending on infrastructure details.
 */
public interface ProjectInitializationPort {
   ...
   */
  void createDirectoryStructure(String projectPath, String packageName)
   ...
   */
  void createAdamComponent(String projectPath, String packageName)
      throws ComponentInitializationException;
   ...
   */
  void createConfigurationFiles(String projectPath, String packageName)
      throws ComponentInitializationException;
}
