...
public class EventService {
     ...
     * @param eventType The type of the event
     * @param payload The event payload
     * @return true if the event was published and the notification was sent successfully, false otherwise
     */
    public boolean publishEventWithNotification(String topic, String eventType, String payload) {
        ...
        boolean notificationSent = notificationPort.sendNotification(
                "system", 
