 ...
 *
 * <p>This service provides high-level notification operations for the application, using the
 * NotificationPort interface to abstract the actual notification mechanism.
 *
 * <p>Features:
 *
 * <ul>
 *   <li>Component status and error notifications
 *   <li>Machine creation and status notifications
 *   <li>System warning and error notifications
 *   <li>User-targeted notifications via multiple channels
 *   <li>Push notification support
 *   <li>Asynchronous notification sending
...
public class NotificationService {
   ...
   */
  public NotificationResult sendComponentStatusNotification(
    ...
    return notificationPort.sendSystemNotification(subject, content, NotificationSeverity.INFO);
  }
   ...
   * @return The notification result
   */
  public NotificationResult sendComponentErrorNotification(
      ComponentPort component, String errorMessage) {
    ...
    return notificationPort.sendSystemNotification(subject, content, NotificationSeverity.ERROR);
  }
  ...
  public NotificationResult sendMachineCreationNotification(
    ...
    String content =
        "A new machine has been created: " + name + " (" + machineId + ") of type " + machineType;
  ...
  public NotificationResult sendSystemWarning(String subject, String message) {
    ...
    return notificationPort.sendSystemNotification(subject, message, NotificationSeverity.WARNING);
  }
  ...
  public NotificationResult sendPushNotification(
    ...
    return notificationPort.sendNotificationToRecipient(userId, title, message, severity, metadata);
  }
  ...
  public CompletableFuture<NotificationResult> sendComponentStatusNotificationAsync(
      ComponentPort component, String status) {
    return CompletableFuture.supplyAsync(() -> sendComponentStatusNotification(component, status));
  }
   ...
   * @return The notification result
   */
  public NotificationResult sendSms(
      String phoneNumber, String message, NotificationPort.SmsType smsType) {
    ...
    NotificationResult result =
        notificationPort.sendSmsNotification(formattedPhoneNumber, message, smsType, metadata);
  ...
  public Map<String, NotificationResult> sendBatchSms(
    ...
    logger.info(
        "Batch SMS completed: {} messages, {} successful",
        phoneNumbers.size(),
  ...
  public NotificationResult scheduleSms(
    ...
    if (!notificationPort.isRecipientRegistered(recipientId)) {
      notificationPort.registerSmsRecipient(
          recipientId, formattedPhoneNumber, defaultCountryCode, true);
    }
  ...
  public NotificationResult sendFormattedNotification(
    ...
    logger.debug(
        "Sending formatted {} notification to {} via {}", contentFormat, recipient, channel);
  ...
  public NotificationResult sendSlackNotification(
    ...
    return notificationPort.sendSlackNotification(
        workspace, channel, message, contentFormat, metadata);
  }
  ...
  public NotificationResult sendSlackNotification(
    ...
    return sendSlackNotification(
        workspace, channel, message, NotificationPort.ContentFormat.PLAIN_TEXT);
  }
  ...
  public NotificationResult sendTeamsNotification(
      String teamId, String channel, String message, NotificationPort.ContentFormat contentFormat) {
    ...
    return notificationPort.sendTeamsNotification(
        teamId, channel, message, contentFormat, metadata);
  }
  ...
  public NotificationResult sendTeamsNotification(String teamId, String channel, String message) {
    return sendTeamsNotification(
        teamId, channel, message, NotificationPort.ContentFormat.PLAIN_TEXT);
  }
  ...
  public NotificationResult sendDiscordNotification(
    ...
    return notificationPort.sendDiscordNotification(
        serverId, channel, message, contentFormat, metadata);
  }
  ...
  public NotificationResult sendDiscordNotification(
    ...
    return sendDiscordNotification(
        serverId, channel, message, NotificationPort.ContentFormat.PLAIN_TEXT);
  }
  ...
  public NotificationResult sendTemplatedNotification(
    ...
    logger.debug(
        "Sending templated notification '{}' to {} via {}", templateName, recipient, channel);
  ...
  public boolean registerSlackRecipient(
    ...
    logger.debug(
        "Registering recipient {} for Slack notifications in {}/{}", recipient, workspace, channel);
  ...
  public boolean registerTeamsRecipient(
    ...
    logger.debug(
        "Registering recipient {} for Teams notifications in {}/{}", recipient, teamId, channel);
  ...
  public boolean registerDiscordRecipient(
    ...
    logger.debug(
        "Registering recipient {} for Discord notifications in {}/{}",
        recipient,
        serverId,
        channel);
