...
public class NotificationService {
     ...
     * @return true if the notification was sent successfully, false otherwise
     */
    public boolean sendUserNotification(String userId, String subject, String message, NotificationSeverity severity) {
        ...
        return notificationPort.sendNotificationToRecipient(userId, subject, message, severity, userData);
    }
