 ...
 * Following Clean Architecture principles, it allows the application core to remain independent of
 * specific notification implementation details (email, push notifications, etc.).
 */
public interface NotificationPort {
  ...
  class NotificationResult {
    ...
    public static NotificationResult success(String notificationId) {
      return new NotificationResult(
          notificationId, DeliveryStatus.SENT, "Notification sent successfully");
    }
    ...
    public static NotificationResult success(
        String notificationId, NotificationChannel channel, Map<String, String> metadata) {
      return new NotificationResult(
          notificationId,
          DeliveryStatus.SENT,
    ...
    public static NotificationResult failure(
        String notificationId, String errorMessage, NotificationChannel channel) {
      return new NotificationResult(
          notificationId, DeliveryStatus.FAILED, errorMessage, channel, Map.of());
    }
    ...
    public static NotificationResult scheduled(String notificationId, String scheduledTime) {
      return new NotificationResult(
          ...
          Map.of("scheduledTime", scheduledTime));
    }
  }
   ...
   * @return true if registration was successful, false otherwise
   */
  default boolean registerSmsRecipient(
      String recipient, String phoneNumber, String countryCode, boolean optIn) {
   ...
   * @return The notification result
   */
  default NotificationResult sendSlackNotification(
   ...
   * @return The notification result
   */
  default NotificationResult sendDiscordNotification(
   ...
   * @return true if registration was successful, false otherwise
   */
  boolean registerChannelRecipient(
   ...
   * @return true if registration was successful, false otherwise
   */
  default boolean registerSlackRecipient(
   ...
   * @return true if registration was successful, false otherwise
   */
  default boolean registerTeamsRecipient(
   ...
   * @return true if registration was successful, false otherwise
   */
  default boolean registerDiscordRecipient(
