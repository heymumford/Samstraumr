...
public class NotificationResult {
  ...
  /**
   * Indicates whether the notification was sent. This is used by test code for verification.
   *
  ...
  public static NotificationResult success(String message) {
    return new NotificationResult(
        true, generateId(), DeliveryStatus.DELIVERED, message, null, null);
  }
  ...
  public static NotificationResult success(
      String message, DeliveryStatus status, Map<String, String> metadata) {
  ...
  public static NotificationResult failure(String message, String errorDetails) {
    return new NotificationResult(
        false, generateId(), DeliveryStatus.FAILED, message, errorDetails, null);
  }
