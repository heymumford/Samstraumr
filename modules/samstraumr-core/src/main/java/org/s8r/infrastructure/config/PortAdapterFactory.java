 ...
 *
 * <p>This factory provides methods for creating port interfaces from domain entities, following the
 * Dependency Inversion Principle of Clean Architecture. It allows higher-level modules to depend on
