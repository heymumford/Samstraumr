 ...
 *
 * <p>This package contains the Tube concept, which is the original foundation of the Samstraumr
 * framework. Tubes represent atomic processing units that can be composed together to form more
