 ...
 * 
 * <p>This exception includes detailed information about the terminated component
 * such as the component ID, the reason for termination, and the timestamp when
 * termination occurred.</p>
 */
public class ComponentTerminatedException extends RuntimeException {
     ...
     */
    public ComponentTerminatedException(String message, String componentId, 
                                       String terminationReason, String terminationTimestamp) {
        super(message);
     ...
     * @param terminationTimestamp The timestamp when termination occurred
     */
    public ComponentTerminatedException(String componentId, 
                                       String terminationReason, String terminationTimestamp) {
        this("Operation failed: Component is terminated", componentId, terminationReason, terminationTimestamp);
    }
