...
public enum Status {
  ...
  /**
   * The component is functioning but with reduced capabilities or performance. In this state, the
   * component can still perform its essential functions but may be operating with limited features
   * or at reduced efficiency.
   */
  DEGRADED,
