/**
 * Core package contains fundamental framework abstractions and implementations.
 *
 * <p>This package provides the core abstractions that form the foundation of the Samstraumr
 * framework. It includes base classes and interfaces that define the fundamental concepts of the
