...
/**
 * Test runner for tube acceptance tests from the comprehensive acceptance test suite.
 * Runs Cucumber tests defined in the tube-acceptance-tests.feature file.
 */
...
/**
 * Test runner for tube-based business data processing acceptance tests.
 * Runs Cucumber tests defined in the acceptance-test.feature file.
 */
@RunWith(Cucumber.class)
@CucumberOptions(
...
/**
 * Test runner for all tube acceptance tests across the system.
 * Runs all Cucumber tests tagged with TubeAcceptance.
 */
@RunWith(Cucumber.class)
@CucumberOptions(
    features = {
