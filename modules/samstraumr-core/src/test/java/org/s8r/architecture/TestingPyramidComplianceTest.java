...
public class TestingPyramidComplianceTest {
  ...
  private static final Path TEST_DIR =
      Paths.get(
          "/home/emumford/NativeLinuxProjects/Samstraumr/Samstraumr/samstraumr-core/src/test");
  ...
  class TestLevelsTests {
    ...
    void l0UnitLevelTestsShouldExist() throws IOException {
      ...
      boolean hasTubeTests =
          hasTestFilesMatching("tube")
              || hasFeatureFilesInDirectory("L0_Tube")
              || hasFeatureFilesInDirectory("L0_Core");

      boolean hasPortTests = hasTestFilesMatching("Port") || hasTestFilesMatching("Adapter");
    ...
    void l1ComponentLevelTestsShouldExist() throws IOException {
      ...
      boolean hasComponentTests =
          hasTestFilesMatching("component")
      ...
      assertTrue(
          hasComponentTests || hasServiceTests, "Should have L1 (Component/Composite) level tests");
    }
    ...
    void l2IntegrationLevelTestsShouldExist() throws IOException {
      ...
      boolean hasIntegrationTests =
          hasTestFilesMatching("machine") || hasFeatureFilesInDirectory("L2_Machine");

      boolean hasPortIntegrationTests =
          hasFeatureFilesInDirectory("port-interfaces") || hasTestFilesMatching("PortRunner");

      assertTrue(
          hasIntegrationTests || hasPortIntegrationTests,
          "Should have L2 (Integration/Machine) level tests");
    }
    ...
    void l3SystemLevelTestsShouldExist() throws IOException {
      ...
      boolean hasSystemTests =
          hasTestFilesMatching("system") || hasFeatureFilesInDirectory("L3_System");
  ...
  class TestRunnerTests {
    ...
    void testRunnersShouldExistForDifferentTestTypes() throws IOException {
      ...
      boolean hasComponentRunner =
          runnerFiles.stream().anyMatch(p -> p.getFileName().toString().contains("Component"));

      boolean hasTubeRunner =
          runnerFiles.stream().anyMatch(p -> p.getFileName().toString().contains("Tube"));

      boolean hasMachineRunner =
          runnerFiles.stream().anyMatch(p -> p.getFileName().toString().contains("Machine"));
  ...
  class CleanArchitectureTests {
    ...
    void portInterfacesShouldFollowCleanArchitecturePrinciples() throws IOException {
      ...
      List<Path> portInterfaces =
          findFiles(
              Paths.get(
                  "/home/emumford/NativeLinuxProjects/Samstraumr/Samstraumr/samstraumr-core/src/main/java/org/s8r/application/port"),
              "Port.java");
      ...
      List<Path> adapters =
          findFiles(
              Paths.get(
                  "/home/emumford/NativeLinuxProjects/Samstraumr/Samstraumr/samstraumr-core/src/main/java/org/s8r/infrastructure"),
              "Adapter.java");
      ...
      List<Path> services =
          findFiles(
              Paths.get(
                  "/home/emumford/NativeLinuxProjects/Samstraumr/Samstraumr/samstraumr-core/src/main/java/org/s8r/application/service"),
              "Service.java");
    ...
    void portInterfacesShouldHaveTestsFollowingTDDPrinciples() throws IOException {
      ...
      for (Path portInterface : portInterfaces) {
        ...
        List<Path> adapterTests =
            findFiles(TEST_JAVA_DIR, baseName.replace("Port", "Adapter") + "Test.java");
        List<Path> serviceTests =
            findFiles(TEST_JAVA_DIR, baseName.replace("Port", "Service") + "Test.java");

        boolean hasTests =
            !contractTests.isEmpty() || !adapterTests.isEmpty() || !serviceTests.isEmpty();
