...
/**
 * Utility for analyzing architectural compliance with Clean Architecture principles. This class
 * provides methods to verify package dependencies, detect circular dependencies, and analyze the
...
public class ArchitectureAnalyzer {
   ...
   * @throws IOException if an I/O error occurs
   */
  public static Map<String, List<String>> analyzePackageDependencies(String sourcePath)
      throws IOException {
   ...
   * @throws IOException if an I/O error occurs
   */
  public static List<List<String>> detectCircularDependencies(String sourcePath)
      throws IOException {
    List<Path> javaFiles = findJavaFiles(sourcePath);
