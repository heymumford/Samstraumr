...
public class TaskExecutionServiceTest {
  ...
  void initialize_shouldCallPortInitialize() {
    // Arrange
    when(mockTaskExecutionPort.initialize())
        .thenReturn(TaskExecutionPort.TaskResult.success(null, "Initialized successfully"));
  ...
  void executeTask_shouldReturnTaskIdOnSuccess() {
    ...
    when(mockTaskExecutionPort.submitTask(any(Runnable.class), any(TaskOptions.class)))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task submitted successfully"));
  ...
  void executeTask_shouldLogWarningAndReturnEmptyOnFailure() {
    ...
    when(mockTaskExecutionPort.submitTask(any(Runnable.class), any(TaskOptions.class)))
        .thenReturn(TaskExecutionPort.TaskResult.failure(null, "Submission failed", "Test error"));
  ...
  void executeTask_withCallableShouldReturnTaskIdOnSuccess() {
    ...
    when(mockTaskExecutionPort.submitTask(any(Callable.class), any(TaskOptions.class)))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task submitted successfully"));
  ...
  void scheduleTask_shouldReturnTaskIdOnSuccess() {
    ...
    when(mockTaskExecutionPort.scheduleTask(
            any(Runnable.class), any(Instant.class), any(TaskOptions.class)))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task scheduled successfully"));
  ...
  void scheduleTask_shouldReturnEmptyForPastExecutionTime() {
    ...
    // Assert
    assertFalse(result.isPresent());
    verify(mockTaskExecutionPort, never())
        .scheduleTask(any(Runnable.class), any(Instant.class), any(TaskOptions.class));
  ...
  void scheduleTask_withCallableShouldReturnTaskIdOnSuccess() {
    ...
    when(mockTaskExecutionPort.scheduleTask(
            any(Callable.class), any(Instant.class), any(TaskOptions.class)))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task scheduled successfully"));
  ...
  void getTask_shouldReturnTaskOnSuccess() {
    ...
    when(mockTaskExecutionPort.getTask(taskId))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task found", attributes));
  ...
  void getTask_shouldReturnEmptyOnNotFound() {
    ...
    when(mockTaskExecutionPort.getTask(taskId))
        .thenReturn(
            TaskExecutionPort.TaskResult.failure(
                taskId, "Task not found", "No task exists with ID"));
  ...
  void cancelTask_shouldReturnTrueOnSuccess() {
    ...
    when(mockTaskExecutionPort.cancelTask(eq(taskId), anyBoolean()))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task cancelled successfully"));
  ...
  void cancelTask_shouldReturnFalseAndLogOnFailure() {
    ...
    when(mockTaskExecutionPort.cancelTask(eq(taskId), anyBoolean()))
        .thenReturn(
            TaskExecutionPort.TaskResult.failure(
                taskId, "Failed to cancel task", "Task already completed"));
  ...
  void getAllTasks_shouldReturnTasksOnSuccess() {
    ...
    when(mockTaskExecutionPort.getAllTasks())
        .thenReturn(
  ...
  void getTasksByStatus_shouldReturnTasksOnSuccess() {
    ...
    when(mockTaskExecutionPort.getTasksByStatus(status))
        .thenReturn(
            TaskExecutionPort.TaskResult.success(null, "Tasks retrieved successfully", attributes));
  ...
  void onTaskCompletion_shouldReturnTrueOnSuccess() {
    ...
    when(mockTaskExecutionPort.registerCompletionListener(taskId, listener))
        .thenReturn(
  ...
  void onTaskCompletion_shouldReturnFalseAndLogOnFailure() {
    ...
    when(mockTaskExecutionPort.registerCompletionListener(taskId, listener))
        .thenReturn(
            TaskExecutionPort.TaskResult.failure(
                taskId, "Failed to register listener", "Task not found"));
  ...
  void executeAsync_shouldReturnCompletableFuture() throws Exception {
    ...
    when(mockTaskExecutionPort.submitTask(any(Callable.class)))
        .thenReturn(TaskExecutionPort.TaskResult.success(taskId, "Task submitted successfully"));
    ...
    doAnswer(
        ...
        .when(mockTaskExecutionPort)
        .registerCompletionListener(eq(taskId), any(Consumer.class));
  ...
  void getStatistics_shouldReturnStatsOnSuccess() {
    ...
    when(mockTaskExecutionPort.getStatistics())
        .thenReturn(
  ...
  void getStatistics_shouldReturnEmptyMapAndLogOnFailure() {
    ...
    when(mockTaskExecutionPort.getStatistics())
        .thenReturn(
            TaskExecutionPort.TaskResult.failure(
                null, "Failed to retrieve statistics", "System error"));
  ...
  void shutdown_shouldCallPortShutdown() {
    // Arrange
    when(mockTaskExecutionPort.shutdown())
        .thenReturn(TaskExecutionPort.TaskResult.success(null, "Shutdown successful"));
  ...
  void shutdown_shouldLogErrorOnFailure() {
    // Arrange
    when(mockTaskExecutionPort.shutdown())
        .thenReturn(TaskExecutionPort.TaskResult.failure(null, "Shutdown failed", "Test error"));
  ...
  void shutdownAndWait_shouldCallPortShutdownAndWait() {
    ...
    when(mockTaskExecutionPort.shutdownAndWait(timeout))
        .thenReturn(TaskExecutionPort.TaskResult.success(null, "Shutdown successful"));
