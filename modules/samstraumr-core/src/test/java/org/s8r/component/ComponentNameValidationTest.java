...
/**
 * Integration tests for component name validation in the Component creation methods.
 * Verifies that component name validation is properly integrated with component creation.
 */
...
class ComponentNameValidationTest {
    ...
    void componentCreationValidatesNames() {
        ...
        assertThrows(
            InvalidComponentNameException.class,
            () -> Component.create("ab", new Environment())
        );
        
        // Name with disallowed sequence should fail
        assertThrows(
            InvalidComponentNameException.class,
            () -> Component.createAdam("component..with..dots")
        );
    }
    ...
    void childComponentCreationValidatesNames() {
        ...
        assertThrows(
            InvalidComponentNameException.class,
            () -> parent.createChild("invalid@child")
        );
    ...
    @ParameterizedTest
    @ValueSource(strings = {
        "system.component", "admin.service", "root.network", 
        "global.manager", "internal.controller"
    })
