 ...
 *
 * <p>This test focuses on demonstrating the port interface pattern without relying on the full
...
public class SimplePortInterfaceTest {
  ...
  void testPublishDataThroughPortInterface() {
    ...
    assertTrue(
        activityLog.stream()
            .anyMatch(entry -> entry.contains("Published key1=value1 to channel: test-channel")));
  }
