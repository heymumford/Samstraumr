...
class ComponentTypeIntegrationTest {
    ...
    void componentCreationShouldRejectInvalidTypes() {
        ...
        assertThrows(InvalidComponentTypeException.class, 
                () -> Component.create(id, (String)null));
        ...
        assertThrows(InvalidComponentTypeException.class, 
                () -> Component.create(id, "invalid-type"));
    }
    ...
    void componentShouldValidateOperationsBasedOnType() {
        ...
        Component processorComponent = Component.create(
                ComponentId.create("ProcessorComponent"), 
                ComponentType.PROCESSOR);
        
        Component validatorComponent = Component.create(
                ComponentId.create("ValidatorComponent"), 
    ...
    void componentShouldAllowOperationsWithoutRestrictions() {
        ...
        Component component = Component.create(
                ComponentId.create("StandardComponent"));
    ...
    void componentToStringShouldIncludeType() {
        Component component = Component.create(
                ComponentId.create("TestComponent"), 
