...
class ComponentReferenceValidatorTest {
    ...
    @Test
    @DisplayName("validateComponentReference should throw IllegalArgumentException for null referringComponentId")
    ...
    @Test
    @DisplayName("validateComponentReference should throw IllegalArgumentException for null referencedComponentId")
    ...
    void validateComponentReferencesThrowsWhenAnyComponentDoesNotExist() {
        ...
        Function<ComponentId, Boolean> existsFunction = id -> 
            !id.getIdString().equals(referencedId2.getIdString());
