...
class MachineComponentValidatorTest {
  ...
  void validateComponentExistsThrowsExceptionForNonExistentComponent() {
    ...
    NonExistentComponentReferenceException exception =
        assertThrows(
            ...
            () ->
                MachineComponentValidator.validateComponentExists(
                    machineId, componentId, existsFunction));
  ...
  void validateIsCompositeComponentThrowsExceptionForNonCompositeComponent() {
    ...
    // When / Then
    InvalidCompositeTypeException exception =
        assertThrows(
  ...
  void validateMachineComponentDoesNotThrowForValidComponent() {
    ...
    // When / Then
    assertDoesNotThrow(
        () -> MachineComponentValidator.validateMachineComponent(machine, component));
  }
  ...
  void validateMachineComponentsValidatesMultipleComponents() {
    ...
    // When / Then
    assertDoesNotThrow(
        () -> MachineComponentValidator.validateMachineComponents(machine, component1, component2));
  }
