...
class ComponentTypeValidatorTest {
    ...
    void nullOrEmptyTypeShouldThrow() {
        ...
        // Test null type
        InvalidComponentTypeException exception = assertThrows(
    ...
    void componentTypesShouldBeValidatedForOperations(String typeCode, String operation, boolean expected) {
        ...
        if (expected) {
            assertDoesNotThrow(() -> 
                ComponentTypeValidator.validateComponentTypeForOperation(typeCode, componentId, operation));
        } else {
    ...
    void restrictedOperationsShouldNotBeAllowed(String restrictedOperation) {
        ...
        for (ComponentType type : ComponentType.values()) {
            assertFalse(ComponentTypeValidator.isAllowedForOperation(type.getCode(), restrictedOperation));
    ...
    void operationsWithoutRestrictionsShouldAllowAnyType() {
        ...
        for (ComponentType type : ComponentType.values()) {
            ...
            assertDoesNotThrow(() -> 
                ComponentTypeValidator.validateComponentTypeForOperation(type.getCode(), componentId, operation));
        }
    }
}