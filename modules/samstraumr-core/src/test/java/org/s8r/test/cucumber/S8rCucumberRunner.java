 ...
 * </ul>
 *
 * <p>This runner is specifically designed to work with the new S8r component model and will run all
 * BDD tests that test org.s8r.core classes.
 */
@Suite
@SuiteDisplayName("S8r Framework BDD Tests")
@IncludeEngines("cucumber")
@ConfigurationParameter(key = "cucumber.features", value = "src/test/resources/core/features")
...
@ConfigurationParameter(
    ...
    value =
        "pretty, html:target/cucumber-reports/s8r-core.html, json:target/cucumber-reports/s8r-core.json")
