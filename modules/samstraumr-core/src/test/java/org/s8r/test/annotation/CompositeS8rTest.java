...
/**
 * Marks a test as a composite test, focusing on verifying the behavior of a composite component in
 * the new S8r framework.
 *
 ...
 * distinguishing it from legacy composite tests. It aligns with the component testing level in the
