...
public class CacheFileSystemIntegrationSteps {
  ...
  private Path tempDir =
      Paths.get(System.getProperty("java.io.tmpdir"), "s8r-test").toAbsolutePath();
  ...
  private static class ComplexObject {
    ...
    public boolean equals(Object obj) {
      ...
      return name.equals(other.name) && value == other.value && properties.equals(other.properties);
    }
  }

  @Given("a cache system is initialized with name {string}")
  public void aCacheSystemIsInitializedWithName(String cacheName) {
    cachePort = new InMemoryCacheAdapter(null); // Pass null for the logger in test
  ...
  public void aFileSystemAdapterIsAvailable() throws IOException {
    fileSystemPort = new StandardFileSystemAdapter(null); // Pass null for the logger in test
  ...
  public void theCacheShouldContainTheFollowingEntries(DataTable dataTable) {
    ...
    for (Map<String, String> row : rows) {
      ...
      Assertions.assertEquals(
          expectedValue, actualValue.get(), "Value should match expected value for key: " + key);
    }
  }
  ...
  private String[] getCacheKeys() {
    ...
    return new String[] {"test-key", "key1", "key2", "key3", "complex-key"};
  }
