...
/**
 * Test runner for Component and Identity tests.
 * Runs the critical P0 test cases for Component and Identity features.
 */
@RunWith(Cucumber.class)
@CucumberOptions(
    features = {
        "classpath:features/L0_Component/",
        "classpath:features/L0_Identity/"
    },
    glue = {
