 ...
 * S8r Components (the new implementation in org.s8r.core.tube.impl). It uses a TestContext to
...
public class ComponentSteps {
  ...
  public void componentShouldHaveStatus(String componentId, String expectedStatus) {
    ...
    assertEquals(expected, component.getStatus(), "Component should have status " + expectedStatus);
  }
  ...
  public void componentIsChildOfComponent(String childId, String parentId)
      throws InitializationException {
    Component parent =
        context
            .getComponent(parentId)
            .orElseThrow(
                () -> new IllegalArgumentException("Parent component not found: " + parentId));
