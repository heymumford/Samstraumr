 ...
 * 
 * <p>This class helps migrate tests from old Identity API patterns to new ones
...
public class IdentityCompatUtil {
     ...
     * @return A new child Identity instance
     */
    public static Identity createChildIdentity(String reason, Map<String, String> params, Identity parentIdentity) {
        return Identity.createChildIdentity(reason, params, parentIdentity);
    }
