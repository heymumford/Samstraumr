...
/**
 * Step definitions for pre-conception phase tests, focusing on the environment assessment, creation
 * request preparation, validation, and resource allocation that occurs before actual tube creation.
 */
public class PreConceptionPhaseSteps {
  ...
  public void a_tube_creation_request_is_validated() {
    try {
      ...
      boolean isComplete =
          creationRequest.containsKey("creationPurpose")
      ...
      Map<String, Object> requiredResources =
          (Map<String, Object>) creationRequest.get("requiredResources");

      int availableMemory = Integer.parseInt(environment.getValue("resources.memory.available"));
      int availableProcessingCapacity =
          Integer.parseInt(environment.getValue("resources.processingCapacity.available"));
      int availableConnectionPoints =
          Integer.parseInt(environment.getValue("resources.connectionPoints.available"));
      int availableStateContainers =
          Integer.parseInt(environment.getValue("resources.stateContainers.available"));

      boolean hasEnoughMemory = availableMemory >= (int) requiredResources.get("memory");
      boolean hasEnoughProcessingCapacity =
          availableProcessingCapacity >= (int) requiredResources.get("processingCapacity");
      boolean hasEnoughConnectionPoints =
          availableConnectionPoints >= (int) requiredResources.get("connectionPoints");
      boolean hasEnoughStateContainers =
          availableStateContainers >= (int) requiredResources.get("stateContainers");

      boolean resourcesAvailable =
          hasEnoughMemory
              && hasEnoughProcessingCapacity
              && hasEnoughConnectionPoints
              && hasEnoughStateContainers;
      ...
      LOGGER.info(
          "Validated tube creation request with result: " + (isValid ? "valid" : "invalid"));
    } catch (Exception e) {
      lastException = e;
  ...
  public void resources_are_allocated_for_tube_creation() {
    try {
      ...
      if (creationRequest == null
          || creationRequest.isEmpty()
          || !(boolean) creationRequest.getOrDefault("validated", false)) {
      ...
      Map<String, Object> creationParams =
          (Map<String, Object>) creationRequest.get("creationParams");
      ...
      if (memoryRequired <= availableMemory) {
        ...
        environment.setValue(
            "resources.memory.available", String.valueOf(availableMemory - memoryRequired));
        environment.setValue(
            "resources.memory.allocated." + creationRequest.get("id"),
            String.valueOf(memoryRequired));
      } else {
      ...
      if (processingRequired <= availableProcessing) {
        ...
        environment.setValue(
            "resources.processingCapacity.available",
            String.valueOf(availableProcessing - processingRequired));
        environment.setValue(
            "resources.processingCapacity.allocated." + creationRequest.get("id"),
            String.valueOf(processingRequired));
      } else {
      ...
      if (connectionsRequired <= availableConnections) {
        ...
        environment.setValue(
            "resources.connectionPoints.available",
            String.valueOf(availableConnections - connectionsRequired));
        environment.setValue(
            "resources.connectionPoints.allocated." + creationRequest.get("id"),
            String.valueOf(connectionsRequired));
      } else {
        // Rollback previous allocations
        environment.setValue("resources.memory.available", String.valueOf(availableMemory));
        environment.setValue("resources.memory.allocated." + creationRequest.get("id"), null);
        environment.setValue(
            "resources.processingCapacity.available", String.valueOf(availableProcessing));
        environment.setValue(
            "resources.processingCapacity.allocated." + creationRequest.get("id"), null);
      ...
      if (containersRequired <= availableContainers) {
        ...
        environment.setValue(
            "resources.stateContainers.available",
            String.valueOf(availableContainers - containersRequired));
        environment.setValue(
            "resources.stateContainers.allocated." + creationRequest.get("id"),
            String.valueOf(containersRequired));
      } else {
        // Rollback previous allocations
        environment.setValue("resources.memory.available", String.valueOf(availableMemory));
        environment.setValue("resources.memory.allocated." + creationRequest.get("id"), null);
        ...
        environment.setValue(
            "resources.processingCapacity.allocated." + creationRequest.get("id"), null);
        environment.setValue(
            "resources.connectionPoints.available", String.valueOf(availableConnections));
        environment.setValue(
            "resources.connectionPoints.allocated." + creationRequest.get("id"), null);
    ...
    try {
      ...
      try {
        ...
        throw new AssertionError(
            "Resource allocation should have failed for resource-exceeding request");
  ...
  public void the_environment_should_have_a_stable_configuration() {
    ...
    Assertions.assertEquals(
        "true",
        environment.getValue("environment.stable"),
  ...
  public void the_environment_should_have_resource_allocation_capabilities() {
    Assertions.assertNotNull(
        environment.getValue("resources.memory.total"),
        "Environment should track total memory resources");
    Assertions.assertNotNull(
        environment.getValue("resources.memory.available"),
        "Environment should track available memory resources");

    Assertions.assertNotNull(
        environment.getValue("resources.processingCapacity.total"),
        "Environment should track total processing capacity");
    Assertions.assertNotNull(
        environment.getValue("resources.processingCapacity.available"),
  ...
  public void the_environment_should_provide_isolation_boundaries() {
    Assertions.assertEquals(
        "true",
        environment.getValue("isolation.enabled"),
        "Environment should have isolation enabled");
    Assertions.assertNotNull(
        environment.getValue("isolation.boundary.type"),
  ...
  public void the_environment_should_have_identity_generation_mechanisms() {
    Assertions.assertEquals(
        "true",
        environment.getValue("identity.generation.enabled"),
        "Environment should have identity generation enabled");
    Assertions.assertNotNull(
        environment.getValue("identity.generation.method"),
  ...
  public void the_request_should_contain_a_creation_purpose() {
    Assertions.assertNotNull(
        creationRequest.get("creationPurpose"), "Creation request should contain a purpose");
    Assertions.assertFalse(
        creationRequest.get("creationPurpose").toString().isEmpty(),
  ...
  public void the_request_should_specify_required_resources() {
    ...
    Assertions.assertTrue(
        resources.containsKey("memory"), "Required resources should specify memory");
    Assertions.assertTrue(
        resources.containsKey("processingCapacity"),
        "Required resources should specify processing capacity");
    Assertions.assertTrue(
        resources.containsKey("connectionPoints"),
        "Required resources should specify connection points");
    Assertions.assertTrue(
        resources.containsKey("stateContainers"),
        "Required resources should specify state containers");
  }
  ...
  public void the_request_should_indicate_the_intended_lifespan() {
    ...
    Assertions.assertTrue(
        lifespan.containsKey("estimatedDuration"), "Lifespan should specify estimated duration");
    Assertions.assertTrue(
        lifespan.containsKey("persistAfterCompletion"),
        "Lifespan should specify persistence preference");
  }
  ...
  public void the_request_should_define_the_interaction_model() {
    ...
    Map<String, Object> interactionModel =
        (Map<String, Object>) creationRequest.get("interactionModel");
    Assertions.assertTrue(
        interactionModel.containsKey("inputMode"), "Interaction model should specify input mode");
    Assertions.assertTrue(
        interactionModel.containsKey("outputMode"), "Interaction model should specify output mode");
    Assertions.assertTrue(
        interactionModel.containsKey("isolationLevel"),
        "Interaction model should specify isolation level");
  }

  @Then("the request should be checked for completeness")
  public void the_request_should_be_checked_for_completeness() {
    Assertions.assertTrue(
        validationResults.containsKey("complete"), "Validation should check request completeness");
  }
  ...
  public void the_request_should_be_evaluated_for_resource_availability() {
    Assertions.assertTrue(
        validationResults.containsKey("resourcesAvailable"),
  ...
  public void the_request_should_be_analyzed_for_potential_conflicts() {
    Assertions.assertTrue(
        validationResults.containsKey("noConflicts"),
  ...
  public void memory_resources_should_be_reserved() {
    Assertions.assertTrue(
        allocatedResources.containsKey("memory"), "Memory resources should be reserved");

    int memoryAllocated = (int) allocatedResources.get("memory");
    int memoryRequired =
        (int) ((Map<String, Object>) creationRequest.get("requiredResources")).get("memory");

    Assertions.assertEquals(
        memoryRequired, memoryAllocated, "Allocated memory should match requested amount");

    // Verify environment tracking
    String allocatedInEnv =
        environment.getValue("resources.memory.allocated." + creationRequest.get("id"));
    Assertions.assertNotNull(allocatedInEnv, "Environment should track allocated memory");
    Assertions.assertEquals(
        String.valueOf(memoryAllocated),
        allocatedInEnv,
  ...
  public void identity_resources_should_be_prepared() {
    Assertions.assertTrue(
        allocatedResources.containsKey("identityId"), "Identity resources should be prepared");
    ...
    Assertions.assertEquals(
        identityId, reservedInEnv, "Environment should track reserved identity");
  }

  @And("environmental context should be captured")
  public void environmental_context_should_be_captured() {
    Assertions.assertTrue(
        allocatedResources.containsKey("environmentalContext"),
        "Environmental context should be captured");

    Map<String, String> context =
        (Map<String, String>) allocatedResources.get("environmentalContext");
  ...
  public void initialization_parameters_should_be_established() {
    Assertions.assertTrue(
        allocatedResources.containsKey("initializationParameters"),
        "Initialization parameters should be established");

    Map<String, Object> params =
        (Map<String, Object>) allocatedResources.get("initializationParameters");
    ...
    Assertions.assertNotNull(
        params.get("environmentalContext"), "Parameters should include environmental context");
  }
  ...
  public void the_creation_process_should_be_rejected() {
    ...
    if (validationResults.containsKey("valid")) {
      Assertions.assertFalse(
          (boolean) validationResults.get("valid"),
  ...
  public void appropriate_error_information_should_be_provided() {
    if (validationResults.containsKey("error")) {
      ...
      Assertions.assertTrue(
          errorMessage.contains("resource") || errorMessage.contains("insufficient"),
  ...
  public void no_partial_tube_structure_should_remain() {
    // This is difficult to verify directly, but we can check that allocated resources were properly
    // released
  ...
  public void resources_should_be_properly_released() {
    ...
    String memoryAllocation =
        environment.getValue("resources.memory.allocated." + creationRequest.get("id"));
    String processingAllocation =
        environment.getValue("resources.processingCapacity.allocated." + creationRequest.get("id"));
    String connectionsAllocation =
        environment.getValue("resources.connectionPoints.allocated." + creationRequest.get("id"));
    String containersAllocation =
        environment.getValue("resources.stateContainers.allocated." + creationRequest.get("id"));

    // These should all be null or empty after proper cleanup
    Assertions.assertTrue(
        memoryAllocation == null || memoryAllocation.isEmpty(),
        "Memory allocation should be cleaned up");
    Assertions.assertTrue(
        processingAllocation == null || processingAllocation.isEmpty(),
        "Processing capacity allocation should be cleaned up");
    Assertions.assertTrue(
        connectionsAllocation == null || connectionsAllocation.isEmpty(),
        "Connection points allocation should be cleaned up");
    Assertions.assertTrue(
        containersAllocation == null || containersAllocation.isEmpty(),
        "State containers allocation should be cleaned up");

    // Identity reservation should also be cleared
    String identityReservation =
        environment.getValue("identity.reserved." + creationRequest.get("id"));
    Assertions.assertTrue(
        identityReservation == null || identityReservation.isEmpty(),
