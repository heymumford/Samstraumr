 ...
 * S8r Composites (the new implementation in org.s8r.core.composite). It uses a TestContext to
...
public class CompositeSteps {
  ...
  public void aCompositeWithId(String compositeId) {
    Environment env = context.getEnvironment();
    Composite composite =
        CompositeFactory.createComposite(compositeId, CompositeType.OBSERVER, env);
    context.addComposite(compositeId, composite);
  }
  ...
  public void componentAddedToComposite(String componentId, String compositeId)
  ...
  public void componentsAreConnectedInComposite(
      String sourceId, String targetId, String compositeId) {
    Composite composite =
        context
            .getComposite(compositeId)
            .orElseThrow(() -> new IllegalArgumentException("Composite not found: " + compositeId));
  ...
  public void compositeShouldHaveStatus(String compositeId, String expectedStatus) {
    ...
    assertEquals(expected, composite.getStatus(), "Composite should have status " + expectedStatus);
  }
  ...
  public void compositeShouldContainComponent(String compositeId, String componentId) {
    ...
    assertEquals(
        componentId, component.getReason(), "Component should have the correct reason/name");
  }
  ...
  public void compositeShouldBeOfType(String compositeId, String expectedType) {
    ...
    assertEquals(expected, composite.getType(), "Composite should be of type " + expectedType);
  }
}
