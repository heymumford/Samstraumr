 ...
 *
 * <p>This suite runs all Cucumber features related to Composite components. It includes the
 * composite-patterns directory and also the patterns directory which includes pattern
 * implementations for composites.
 *
 * <p>To run this suite, use one of these methods:
 *
 * <ul>
 *   <li>Maven: {@code mvn test -Dtest=CompositeTests}
 *   <li>s8r-test script: {@code ./s8r-test composite}
 * </ul>
 */
@Suite
