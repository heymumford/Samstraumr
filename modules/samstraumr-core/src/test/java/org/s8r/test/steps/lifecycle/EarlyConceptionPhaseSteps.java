...
/**
 * Step definitions for early conception phase tests, focusing on identity formation at the
...
public class EarlyConceptionPhaseSteps {
  ...
  public void an_existing_parent_tube() {
    ...
    try {
      ...
      Assertions.assertEquals(
          State.ACTIVE, parentComponent.getState(), "Parent tube should be in ACTIVE state");
  ...
  public void the_identity_should_record_the_creation_purpose() {
    ...
    Assertions.assertTrue(
        purpose.contains("Early Conception Test")
  ...
  public void the_identity_should_establish_existence_boundaries() {
    ...
    Assertions.assertNotNull(
        component.getState(), "Component should have a defined lifecycle state");
  ...
  public void the_identity_should_establish_a_root_address() {
    ...
    Assertions.assertTrue(
        address.startsWith("/") || address.matches("[A-Za-z0-9\\-_]+"),
  ...
  public void the_identity_should_have_no_parent_reference() {
    ...
    try {
      ...
      Assertions.assertTrue(
          e.getMessage().contains("parent") || e.getMessage().contains("Adam"),
  ...
  public void the_identity_should_incorporate_environmental_signatures() {
    ...
    Assertions.assertEquals(
        environmentContext.get("signature").toString(),
        signature,
  ...
  public void the_identity_should_adapt_to_environmental_constraints() {
    ...
    Assertions.assertEquals(
        environmentContext.get("constraints").toString(),
        constraints,
  ...
  public void the_identity_should_be_traceable_to_its_environment() {
    ...
    Assertions.assertNotNull(
        env.getValue("domain"), "Environment should contain domain information");
    Assertions.assertEquals(
        environmentContext.get("domain").toString(),
        env.getValue("domain"),
        "Environmental domain should match");

    Assertions.assertNotNull(
        env.getValue("purpose"), "Environment should contain purpose information");
    Assertions.assertEquals(
        environmentContext.get("purpose").toString(),
        env.getValue("purpose"),
  ...
  public void the_child_tube_should_inherit_parent_characteristics() {
    ...
    Assertions.assertEquals(
        parentEnv.getValue("inherited.trait"),
        childEnv.getValue("inherited.trait"),
        "Child should inherit trait from parent");

    Assertions.assertEquals(
        parentEnv.getValue("inherited.capability"),
  ...
  public void the_child_tube_should_maintain_parent_reference() {
    ...
    Assertions.assertEquals(
        parentComponent.getIdentity().getId(),
        parentRef.getId(),
