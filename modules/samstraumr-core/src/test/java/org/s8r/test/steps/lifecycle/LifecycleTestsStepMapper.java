...
/**
 * This class implements missing step definitions identified during test verification. It serves as
 * a direct mapper for steps that weren't properly matched by the verification system.
 */
public class LifecycleTestsStepMapper {
  ...
  private State mapStateNameToEnum(String stateName) {
    ...
    switch (stateName.toUpperCase()) {
      ...
      case "CHILDHOOD":
        return State.ACTIVE; // Map lifecycle phases to closest system state
      case "INFANCY":
        return State.ACTIVE;
      default:
