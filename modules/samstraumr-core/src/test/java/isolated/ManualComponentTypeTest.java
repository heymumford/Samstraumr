...
/**
 * Simple manual test for {@link ComponentTypeValidator} and {@link ComponentType} that runs without
 * JUnit.
 */
public class ManualComponentTypeTest {
  ...
  public static void main(String[] args) {
    ...
    for (ComponentType type : ComponentType.values()) {
      System.out.println(
          "✓ " + type.name() + " (" + type.getCode() + "): " + type.getDescription());
    }
    ...
    System.out.println(
        "standard for SYSTEM_ADMIN: " + (allowed ? "Allowed ✗" : "Not allowed ✓ (restricted)"));
