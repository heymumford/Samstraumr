...
public class IsolatedComponentNameValidatorTest {
  ...
  void validNamesShouldPass() {
    ...
    assertDoesNotThrow(
        () -> ComponentNameValidator.validateComponentName("component_with_underscores"));
  ...
  void nullNameShouldThrow() {
    InvalidComponentNameException exception =
        assertThrows(
  ...
  void tooShortNameShouldThrow() {
    ...
    assertEquals(
        "Component name must be at least "
            + ComponentNameValidator.getMinNameLength()
            + " characters long",
  ...
  void tooLongNameShouldThrow() {
    ...
    assertEquals(
        "Component name must be at most "
            + ComponentNameValidator.getMaxNameLength()
            + " characters long",
        exception.getValidationRule());
