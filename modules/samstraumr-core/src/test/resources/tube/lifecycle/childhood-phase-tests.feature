@FunctionalIdentity @BasicOperations @Positive @Childhood @L0_Tube @ATL @Function
Feature: Tube Functional Identity - Childhood Phase
  ...
  @FunctionalIdentity @DataProcessing @Positive @Childhood @L0_Tube @ATL @Function @Flow
  ...
  @FunctionalIdentity @StateLearning @Positive @Childhood @L0_Tube @ATL @Function @State @Learning
  ...
  @FunctionalIdentity @ErrorRecovery @Negative @Childhood @L0_Tube @BTL @Function @Resilience
