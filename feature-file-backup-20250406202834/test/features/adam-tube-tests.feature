...
Feature: Adam Tube Concept - Origin Point
  ...
  @SubstrateIdentity @AdamTube @Positive @Conception @L0_Tube @ATL @Identity
  ...
  @SubstrateIdentity @AdamTube @Positive @Conception @L0_Tube @ATL @Identity @Hierarchy
  ...
  @SubstrateIdentity @AdamTube @Negative @Conception @L0_Tube @ATL @Identity @Validation
  ...
  @SubstrateIdentity @AdamTube @Positive @Conception @L0_Tube @ATL @Identity @Lineage
