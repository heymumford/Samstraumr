@AtomicTube @Identity @Initialization @L0_Tube @ATL
Feature: Atomic Tube Concept
  ...
  @AtomicTube @Identity @Initialization @L0_Tube @ATL @Positive
  ...
  @AtomicTube @Identity @Initialization @L0_Tube @ATL @Negative
  ...
  @AtomicTube @Lifecycle @State @L0_Tube @ATL @Positive
  ...
  @AtomicTube @Resources @Termination @L0_Tube @ATL @Positive
  ...
  @AtomicTube @Memory @Logging @L0_Tube @ATL @Positive
