@SubstrateIdentity @EarlyConception @L0_Tube @ATL @Identity
Feature: Tube Early Conception Phase Tests
  ...
  @SubstrateIdentity @EarlyConception @ATL @Identity @Genesis @Positive
  ...
  @SubstrateIdentity @EarlyConception @ATL @Identity @Differentiation @Positive
  ...
  @SubstrateIdentity @EarlyConception @ATL @Identity @EnvironmentalInfluence @Positive
  ...
  @SubstrateIdentity @EarlyConception @ATL @Identity @MitosisMetaphor @Positive
  ...
  @SubstrateIdentity @EarlyConception @ATL @Identity @Negative
