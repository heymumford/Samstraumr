...
Feature: Machine Orchestration
  ...
  @ATL @L2_Machine @Orchestration @CompositeManagement
  ...
  @ATL @L2_Machine @Orchestration @CompositeConnectivity
  ...
  @ATL @L2_Machine @Orchestration @StateManagement
  ...
  @ATL @L2_Machine @Orchestration @ShutdownSequence
