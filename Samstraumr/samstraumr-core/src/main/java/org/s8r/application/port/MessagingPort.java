 ...
 * <p>
 * This port provides messaging capabilities between components and potential external
 * systems, extending the event-driven architecture with more general messaging patterns.
 * It follows Clean Architecture principles by defining a boundary between the application
...
public interface MessagingPort {
    ...
    final class MessageResult {
        ...
        private MessageResult(boolean successful, String messageId, String message, String reason, Map<String, Object> attributes) {
         ...
         * @return A new MessageResult instance indicating success
         */
        public static MessageResult success(String messageId, String message, Map<String, Object> attributes) {
         ...
         * @return A new MessageResult instance indicating failure
         */
        public static MessageResult failure(String messageId, String message, String reason, Map<String, Object> attributes) {
