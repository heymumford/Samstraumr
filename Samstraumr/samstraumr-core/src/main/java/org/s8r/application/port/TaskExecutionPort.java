 ...
 * <p>
 * This port provides asynchronous task execution, scheduling, and monitoring capabilities.
 * It follows Clean Architecture principles by defining a boundary between the application
 * and infrastructure layers for task execution concerns.
 */
public interface TaskExecutionPort {
    ...
    final class TaskResult {
        ...
        private TaskResult(boolean successful, String taskId, String message, String reason, Map<String, Object> attributes) {
         ...
         * @return A new TaskResult instance indicating success
         */
        public static TaskResult success(String taskId, String message, Map<String, Object> attributes) {
         ...
         * @return A new TaskResult instance indicating failure
         */
        public static TaskResult failure(String taskId, String message, String reason, Map<String, Object> attributes) {
