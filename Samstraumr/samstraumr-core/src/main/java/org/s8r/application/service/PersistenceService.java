 ...
 * 
 * <p>This service provides high-level persistence operations for the application,
 * using the PersistencePort interface to abstract the actual persistence mechanism.
 */
public class PersistenceService {
    ...
    public PersistenceResult saveComponent(ComponentPort component) {
        ...
        if (!validationResult.isValid()) {
            ...
            return PersistenceResult.failure("Validation failed: " + 
    ...
    public PersistenceResult saveMachine(MachinePort machine) {
        ...
        return persistencePort.save(
            ENTITY_TYPE_MACHINE,
            machine.getId().getShortId(),
            createMachineData(machine)
        );
    }
    ...
    public Optional<String> getConfigurationValue(String key) {
        ...
        Optional<Map<String, Object>> data = 
            persistencePort.findById(ENTITY_TYPE_CONFIGURATION, key);
    ...
    public Map<String, String> getAllConfigurationEntries() {
        ...
        List<Map<String, Object>> entries = 
            persistencePort.findByType(ENTITY_TYPE_CONFIGURATION);
