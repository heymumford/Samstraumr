...
/**
 * SecurityPort defines the interface for security-related operations in the S8r framework.
 * This port handles authentication, authorization, and security token management.
 * <p>
 * Following clean architecture principles, this port interface allows the application core
...
public interface SecurityPort {
    ...
    final class SecurityResult {
        ...
        private SecurityResult(boolean successful, String message, String reason, Map<String, Object> attributes) {
         ...
         * @return A new SecurityResult instance indicating failure
         */
        public static SecurityResult failure(String message, String reason, Map<String, Object> attributes) {
    ...
    final class AuthenticationContext {
         ...
         */
        public AuthenticationContext(String userId, String username, Set<String> roles,
                                     Set<String> permissions, Instant authenticatedAt,
                                     Duration sessionValidity, Map<String, Object> attributes) {
            this.userId = userId;
