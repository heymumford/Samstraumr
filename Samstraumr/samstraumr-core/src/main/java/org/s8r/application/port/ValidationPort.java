 ...
 * 
 * <p>This interface defines standard operations for validating data in the application.
 * Following Clean Architecture principles, it allows the application core to remain
 * independent of specific validation implementation details.
 */
public interface ValidationPort {
     ...
     * @return The validation result
     */
    ValidationResult validateAllowedValues(String fieldName, Object value, List<Object> allowedValues);
