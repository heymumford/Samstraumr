 ...
 * 
 * <p>This port defines how the application layer obtains loggers, allowing for different
 * logging implementations to be used without changing the application code.
 */
