...
public interface SecurityPort {
   ...
   * @return The authentication result
   */
  AuthenticationResult authenticate(String username, String password, Map<String, String> additionalFactors);
  ...
  class TokenRefreshResult extends OperationResult {
     ...
     */
    public static TokenRefreshResult success(String message, SecurityToken newToken, String refreshToken) {
  ...
  class PasswordUpdateResult extends OperationResult {
    ...
    private PasswordUpdateResult(String message, boolean requiresPasswordChange, Optional<Duration> passwordExpiresIn) {
      super(message);
  ...
  class EncryptionResult extends OperationResult {
     ...
     */
    public static EncryptionResult success(String message, byte[] encryptedData, String keyIdentifier) {
  ...
  class DecryptionResult extends OperationResult {
     ...
     */
    public static DecryptionResult success(String message, byte[] decryptedData, String keyIdentifier) {
