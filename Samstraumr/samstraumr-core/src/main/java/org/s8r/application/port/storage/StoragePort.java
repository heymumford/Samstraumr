...
public interface StoragePort {
   ...
   * @return The result of the operation
   */
  ObjectResult storeObject(String containerName, String key, InputStream inputStream, long size, ObjectOptions options);
  ...
  abstract class OperationResult {
     ...
     * @return The OperationResult
     */
    public static OperationResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class ContainerResult extends OperationResult {
     ...
     * @return The ContainerResult
     */
    public static ContainerResult success(String message, Container container, Map<String, String> attributes) {
     ...
     * @return The ContainerResult
     */
    public static ContainerResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class ContainerListResult extends OperationResult {
    ...
    private ContainerListResult(String message, List<Container> containers, boolean hasMoreResults, Map<String, String> attributes) {
      super(message, attributes);
     ...
     */
    public static ContainerListResult success(String message, List<Container> containers, boolean hasMoreResults) {
    ...
    public static ContainerListResult success(
        String message, List<Container> containers, boolean hasMoreResults, Map<String, String> attributes) {
     ...
     * @return The ContainerListResult
     */
    public static ContainerListResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class ObjectResult extends OperationResult {
     ...
     * @return The ObjectResult
     */
    public static ObjectResult success(String message, StorageObject object, Map<String, String> attributes) {
     ...
     * @return The ObjectResult
     */
    public static ObjectResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class ObjectListResult extends OperationResult {
    ...
    public static ObjectListResult success(
        String message, List<StorageObject> objects, boolean hasMoreResults, List<String> commonPrefixes) {
     ...
     * @return The ObjectListResult
     */
    public static ObjectListResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class ObjectMetadataResult extends OperationResult {
    ...
    public static ObjectMetadataResult success(
        ...
        Map<String, String> metadata,
        Optional<String> contentHash) {
      return success(message, contentType, contentLength, lastModified, metadata, contentHash, Map.of());
    }
     ...
     * @return The ObjectMetadataResult
     */
    public static ObjectMetadataResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class UrlResult extends OperationResult {
    ...
    private UrlResult(String message, String url, Instant expiresAt, Map<String, String> attributes) {
      super(message, attributes);
     ...
     * @return The UrlResult
     */
    public static UrlResult success(String message, String url, Instant expiresAt, Map<String, String> attributes) {
     ...
     * @return The UrlResult
     */
    public static UrlResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class KvResult extends OperationResult {
    ...
    private KvResult(String message, String value, Optional<Instant> expiresAt, Map<String, String> attributes) {
      super(message, attributes);
     ...
     * @return The KvResult
     */
    public static KvResult failure(String message, String errorCode, Map<String, String> attributes) {
  ...
  class KvListResult extends OperationResult {
    ...
    private KvListResult(String message, List<String> keys, boolean hasMoreResults, Map<String, String> attributes) {
      super(message, attributes);
      this.keys = keys;
      this.hasMoreResults = hasMoreResults;
    }
     ...
     * @return The KvListResult
     */
    public static KvListResult failure(String message, String errorCode, Map<String, String> attributes) {
