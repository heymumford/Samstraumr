 ...
 * allowing a component to manage its own data flow subscriptions and publications without
 * needing to specify its ID for each operation.
 * 
 * <p>This follows the Clean Architecture port pattern for the domain layer, defining
 * capabilities that components can use without depending on implementation details.
 */
