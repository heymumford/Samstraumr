 ...
 * <p>
 * This interface defines the contract for components in the domain layer,
 * allowing adapter implementations to bridge between legacy implementations
 * and the clean architecture domain model.
 * </p>
 */
public interface ComponentPort {
     ...
     * @throws org.s8r.domain.exception.InvalidStateTransitionException if the transition is not allowed
     */
     ...
     *
     * @throws org.s8r.domain.exception.InvalidOperationException if the component is not in READY state
     */
    void activate();
     ...
     *
     * @throws org.s8r.domain.exception.InvalidOperationException if the component is not in ACTIVE state
     */
    void deactivate();
