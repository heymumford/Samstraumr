 ...
 *
 * <p>Package containing logging infrastructure for components in the S8r framework
 */
 ...
 * </ul>
 *
 * <p>The design of this package emphasizes simplicity and integration by combining what were
 * previously separate classes (Logger and LoggerInfo) into a single class with nested components.
 *
 * <p>Example usage:
 *
 * <pre>
