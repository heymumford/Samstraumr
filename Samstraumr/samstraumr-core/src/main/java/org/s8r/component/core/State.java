 ...
 *
 * Consolidated state enum combining operational status and lifecycle states
 */
 ...
 * 
 * <p>This enum is part of the simplified package structure, replacing both the Status
 * and LifecycleState enums with a unified concept. States are categorized into:
 * 
 * <ul>
 *   <li>OPERATIONAL - States representing current runtime status</li>
 *   <li>LIFECYCLE - States representing developmental phases</li>
 *   <li>ADVANCED - States representing maturity and specialized behavior</li>
 *   <li>TERMINATION - States representing end-of-life</li>
 * </ul>
 */
public enum State {
    // Operational states
