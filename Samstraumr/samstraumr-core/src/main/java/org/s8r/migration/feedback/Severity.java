...
public enum Severity {
     ...
     * These issues will cause application failure or data loss.
     */
    CRITICAL(4, "Critical"),
    
    /**
     * Error severity - important to fix.
     * These issues will cause incorrect behavior or partial failure.
     */
    ERROR(3, "Error"),
    
    /**
     * Warning severity - should be addressed.
     * These issues may cause problems in some scenarios.
     */
    WARNING(2, "Warning"),
    
    /**
     * Info severity - informational only.
     * These issues are unlikely to cause problems but may be useful to know.
     */
    INFO(1, "Info"),
    
    /**
     * Debug severity - for diagnostic use only.
     * These issues are purely for development and debugging purposes.
     */
    DEBUG(0, "Debug");
