 ...
 * MigrationIssue instances are created by the MigrationIssueLogger
 * and stored in the MigrationFeedback system.
 */
public class MigrationIssue {
    ...
    public String toString() {
        return String.format("%s [%s] %s: %s",
                severity, type, component != null ? component : "",
    ...
    public String toDetailedString() {
        ...
        sb.append(String.format("Component: %s, Property: %s%n", 
                component != null ? component : "N/A", 
                property != null ? property : "N/A"));
        ...
        if (sourceClass != null) {
            sb.append(String.format("Source: %s.%s%n", sourceClass, 
