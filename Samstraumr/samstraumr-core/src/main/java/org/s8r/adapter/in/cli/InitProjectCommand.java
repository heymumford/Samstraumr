 ...
 * <p>
 * This class provides the entry point for initializing a Samstraumr project
...
public class InitProjectCommand {
    ...
    public static void main(String[] args) {
        ...
        ProjectInitializationService initService = ServiceLocator.getServiceFactory()
                .getService(ProjectInitializationService.class);
