...
public class TubeComponentWrapper extends Component implements ComponentPort {
    ...
    public Map<String, String> getEnvironmentParameters() {
        return adapter.getEnvironmentConverter().extractParametersFromLegacyEnvironment(tube.getEnvironment());
    }
    
    @Override
    public String toString() {
        return "TubeComponentWrapper{id=" + getId() + 
               ", tubeId=" + tube.getUniqueId() + 
