 ...
 * <p>
 * This class uses reflection to interact with legacy Environment classes, removing the need for
...
public class ReflectiveEnvironmentConverter implements LegacyEnvironmentConverter {
    ...
    public ReflectiveEnvironmentConverter(String environmentClassName, LoggerPort logger) {
        ...
        try {
            ...
            this.setParameterMethod = environmentClass.getMethod("setParameter", String.class, String.class);
            ...
            throw new IllegalArgumentException("Could not load Environment class: " + environmentClassName, e);
        }
    }
    ...
    public Map<String, String> extractParametersFromLegacyEnvironment(Object legacyEnvironment) {
        if (!environmentClass.isInstance(legacyEnvironment)) {
            throw new IllegalArgumentException("Expected " + environmentClassName + " object, got: " + 
