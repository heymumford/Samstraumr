...
public class LegacyComponentAdapter implements LegacyComponentAdapterPort {
    ...
    public LegacyComponentAdapter(
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not load legacy component class: " + componentClassName, e);
        }
    }
    ...
    public LegacyComponentWrapper wrapLegacyComponent(Object legacyComponent) {
        ...
        if (!componentClass.isInstance(legacyComponent)) {
            throw new IllegalArgumentException("Expected " + componentClassName + " object, got: " + 
        ...
        try {
            ...
            return new LegacyComponentWrapper(
                    componentId, name, type, state, legacyComponent, this);
        } catch (Exception e) {
    ...
    private Method findMethod(String methodName, Class<?>... parameterTypes) {
        try {
            ...
            logger.error("Method {} not found in legacy component class {}", methodName, componentClassName);
