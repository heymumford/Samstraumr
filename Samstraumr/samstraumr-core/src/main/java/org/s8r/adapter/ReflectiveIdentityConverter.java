 ...
 * <p>
 * This class uses reflection to interact with legacy Identity classes, removing the need for
 * direct dependencies on those classes. This aligns with Clean Architecture principles
 * by isolating the adapter implementation details from the domain layer.
 */
public class ReflectiveIdentityConverter implements LegacyIdentityConverter {
    ...
    public ReflectiveIdentityConverter(
        ...
        try {
            ...
            String environmentClassName = environmentConverter.getLegacyEnvironmentClassName(
            ...
            this.createAdamIdentityMethod = identityClass.getMethod("createAdamIdentity", String.class, environmentClass);
            this.createChildIdentityMethod = identityClass.getMethod("createChildIdentity", String.class, environmentClass, identityClass);
            ...
            this.addEnvironmentContextMethod = identityClass.getMethod("addEnvironmentContext", String.class, String.class);
    ...
    public Object createLegacyChildIdentity(String reason, Object legacyEnvironment, Object parentLegacyIdentity) {
        if (!identityClass.isInstance(parentLegacyIdentity)) {
            throw new IllegalArgumentException("Expected " + identityClassName + " object, got: " + 
                    (parentLegacyIdentity != null ? parentLegacyIdentity.getClass().getName() : "null"));
        }
        
        try {
            return createChildIdentityMethod.invoke(null, reason, legacyEnvironment, parentLegacyIdentity);
        } catch (Exception e) {
    ...
    public Map<String, String> getLegacyIdentityEnvironmentContext(Object legacyIdentity) {
        ...
        try {
            @SuppressWarnings("unchecked")
            Map<String, String> context = (Map<String, String>) getEnvironmentContextMethod.invoke(legacyIdentity);
