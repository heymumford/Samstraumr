 ...
 *
 * <p>This package contains the concrete implementations of the component model abstractions
 * defined in the parent package. It is a complete replacement of the legacy implementations,
 * providing a cleaner, more maintainable approach to the component model.
 *
 ...
 * <ul>
 *   <li>{@link org.s8r.core.tube.impl.Component} - Core implementation replacing the legacy Tube class</li>
 * </ul>
 *
 * <p>Example usage:
 * <pre>
