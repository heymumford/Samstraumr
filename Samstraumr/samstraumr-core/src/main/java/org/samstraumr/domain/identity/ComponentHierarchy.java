 ...
 *
 * <p>This class manages parent-child relationships and hierarchical addressing
 * of components in the system, following Clean Architecture principles with
...
public class ComponentHierarchy {
    ...
    public static ComponentHierarchy createChild(ComponentId id, ComponentHierarchy parentHierarchy) {
        ...
        String hierarchicalAddress = parentHierarchy.getHierarchicalAddress() + 
                                    ".CO<" + id.getShortId() + ">";
        
        return new ComponentHierarchy(
            id,
            parentHierarchy.getId(),
            new ArrayList<>(),
            hierarchicalAddress,
            false
        );
    ...
    private ComponentHierarchy(
        ...
        this.hierarchicalAddress = Objects.requireNonNull(hierarchicalAddress, "Hierarchical address cannot be null");
        this.isRoot = isRoot;
    }
