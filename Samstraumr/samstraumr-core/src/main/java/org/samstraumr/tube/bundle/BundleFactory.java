...
/**
 * Factory class for creating and managing Bundles.
 * Provides utilities for creating common bundle patterns.
 */
public class BundleFactory {
    ...
    public static Bundle createTransformationBundle(Environment environment) {
        ...
        // Connect tubes
        bundle.connect("source", "transformer")
    ...
    public static Bundle createValidationBundle(Environment environment) {
        ...
        // Connect tubes
        bundle.connect("processor", "validator")
              .connect("validator", "output");
