 ...
 * 
 * <p>This class is intended for debugging and testing, to show how TubeIdentity
 * objects are constructed and what they contain in memory.
 */
public class TubeIdentityInspector {
    ...
    public static String inspect(TubeIdentity identity) {
        ...
        if (identity.getEnvironmentContext().isEmpty()) {
            ...
            for (String key : identity.getEnvironmentContext().keySet()) {
                sb.append("  * ").append(key).append(": ").append(identity.getEnvironmentContext().get(key)).append("\n");
            }
        }
    ...
    /**
     * Demonstrates the creation and inspection of various identity types.
     * This method can be invoked to see examples of identities in memory.
     * 
    ...
    public static void main(String[] args) {
        ...
        TubeIdentity grandchildId = TubeIdentity.createChildIdentity("Grandchild Tube Demo", env, childId);
