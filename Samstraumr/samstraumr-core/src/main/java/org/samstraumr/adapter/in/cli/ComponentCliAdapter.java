...
import org.samstraumr.domain.exception.ComponentException;
...
public class ComponentCliAdapter {
  ...
  public ComponentCliAdapter() {
    ...
    org.samstraumr.infrastructure.event.InMemoryEventDispatcher eventDispatcher =
        new org.samstraumr.infrastructure.event.InMemoryEventDispatcher(logger);
