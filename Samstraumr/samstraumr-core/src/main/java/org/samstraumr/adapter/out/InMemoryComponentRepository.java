 ...
 *
 * <p>This adapter provides a simple in-memory storage for components,
 * primarily for testing or simple applications. It follows Clean Architecture
 * principles by implementing an application layer port.
 */
