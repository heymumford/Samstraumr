 ...
 * 
 * <p>These tests verify that the essential components of Samstraumr
 * are correctly assembled and can be instantiated. They serve as the
 * first line of defense to ensure the build process was successful
 * and core functionality is available.
 */
@OrchestrationTest
@AboveTheLine
public class BuildIntegrityTest {
    ...
    void compositeWiringShouldFunction() {
        ...
        assertTrue(composite.getConnections().get("source").contains("target"), 
