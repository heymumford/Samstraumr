 ...
 * verify that key properties hold true across a wide range of inputs and environmental conditions.
 */
@AdaptationTest
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class TubeAdaptationTest {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      switch (operation) {
        ...
        case 2:
          ...
          break;
        default:
          // This should never happen as random.nextInt(3) only generates 0, 1, or 2
          tube.logToMimir("Unexpected operation: " + operation);
          break;
      }
    }
