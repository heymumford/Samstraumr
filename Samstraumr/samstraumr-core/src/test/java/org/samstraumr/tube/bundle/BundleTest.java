...
public class BundleTest {
    ...
    public void testEventLogging() {
        ...
        boolean foundStartEvent = events.stream()
                .anyMatch(e -> e.getDescription().contains("Starting data processing"));
        
        boolean foundCompletionEvent = events.stream()
                .anyMatch(e -> e.getDescription().contains("Data processing completed"));
