...
Purpose: System tests for tube interactions with external systems using TestContainers.
Goals:
  - Verify that tubes can interact with external resources like databases and message queues
  - Test resilience of tubes when external systems experience failures or delays
  - Ensure proper resource management and cleanup when working with external systems
Dependencies:
  - JUnit 5 for test framework
  - TestContainers for container-based testing
  - Tube and Bundle classes for component testing
Assumptions:
  - Docker is available in the test environment for TestContainers
  - Network connectivity allows pulling container images
  - Tests manage their own container lifecycle and cleanup
*/
...
/**
 * Stream Tests focus on external system interactions.
 * These tests verify tube behavior when interacting with external resources
 * using TestContainers to provide isolated test environments.
 */
@StreamTest
@Testcontainers
public class StreamTest {
     ...
     * This container is shared across all tests in this class for efficiency.
     */
    @Container
    ...
    void shouldWriteProcessedDataToDatabase() throws SQLException {
        ...
        bundle.addTransformer("sink", (Function<String, String>) data -> {
            try {
