...
public class FileSystemServiceTest {
    ...
    void initialize_shouldCallPortInitialize() {
        // Arrange
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Initialized successfully");
    ...
    void initialize_shouldLogErrorOnFailure() {
        // Arrange
        FileSystemPort.FileResult failResult = FileSystemPort.FileResult.failure("Initialization failed", "Test error");
    ...
    void createDirectory_shouldReturnTrueOnSuccess() {
        ...
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Directory created");
    ...
    void createDirectory_shouldReturnFalseAndLogOnFailure() {
        ...
        FileSystemPort.FileResult failResult = FileSystemPort.FileResult.failure("Failed to create", "Access denied");
    ...
    void deleteFile_shouldCallPortDeleteRecursivelyForRecursive() {
        ...
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Directory deleted");
    ...
    void readFile_shouldReturnContentOnSuccess() {
        ...
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Read successfully", attrs);
    ...
    void readFile_shouldReturnEmptyOnFailure() {
        ...
        FileSystemPort.FileResult failResult = FileSystemPort.FileResult.failure("Failed to read", "File not found");
    ...
    void readLines_withRangeParameters_shouldDelegateCorrectly() {
        ...
        attrs.put("lines", lines);
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Read successfully", attrs);
        when(mockFileSystemPort.readLines(eq(path), any(Charset.class), eq(1L), eq(2L))).thenReturn(successResult);
    ...
    void writeFile_shouldReturnFalseAndLogOnFailure() {
        ...
        String content = "File content";
        FileSystemPort.FileResult failResult = FileSystemPort.FileResult.failure("Failed to write", "Access denied");
        when(mockFileSystemPort.writeString(eq(path), eq(content), any(Charset.class), eq(false)))
    ...
    void setLastModifiedTime_shouldReturnTrueOnSuccess() {
        ...
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Set time successful");
    ...
    void createTempFile_shouldReturnPathOnSuccess() {
        ...
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Temp file created", attrs);
    ...
    void createTempDirectory_shouldReturnPathOnSuccess() {
        ...
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Temp directory created", attrs);
    ...
    void listFiles_shouldReturnFilesOnSuccess() {
        ...
        fileInfos.add(new FileSystemPort.FileInfo("/test/dir/file1.txt", false, true, false, 
                100, Instant.now(), Instant.now(), Instant.now(), Map.of()));
        fileInfos.add(new FileSystemPort.FileInfo("/test/dir/file2.txt", false, true, false, 
                200, Instant.now(), Instant.now(), Instant.now(), Map.of()));
        
        Map<String, Object> attrs = new HashMap<>();
        attrs.put("files", fileInfos);
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Directory listed", attrs);
    ...
    void searchFiles_shouldUseCorrectSearchMode() {
        ...
        Map<String, Object> attrs = new HashMap<>();
        attrs.put("files", fileInfos);
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Search completed", attrs);
        
        // Test with recursive = true
        when(mockFileSystemPort.search(eq(directory), eq(pattern), eq(FileSystemPort.SearchMode.RECURSIVE)))
                .thenReturn(successResult);

        // Act - Recursive
        Optional<List<FileSystemPort.FileInfo>> recursiveResult = service.searchFiles(directory, pattern, true);
        ...
        when(mockFileSystemPort.search(eq(directory), eq(pattern), eq(FileSystemPort.SearchMode.CURRENT_DIRECTORY)))
                .thenReturn(successResult);

        // Act - Current directory
        Optional<List<FileSystemPort.FileInfo>> currentResult = service.searchFiles(directory, pattern, false);

        // Assert - Current directory
        assertTrue(currentResult.isPresent());
        verify(mockFileSystemPort).search(directory, pattern, FileSystemPort.SearchMode.CURRENT_DIRECTORY);
    }
    ...
    void shutdown_shouldCallPortShutdown() {
        // Arrange
        FileSystemPort.FileResult successResult = FileSystemPort.FileResult.success("Shutdown successful");
    ...
    void shutdown_shouldLogErrorOnFailure() {
        // Arrange
        FileSystemPort.FileResult failResult = FileSystemPort.FileResult.failure("Shutdown failed", "Test error");
