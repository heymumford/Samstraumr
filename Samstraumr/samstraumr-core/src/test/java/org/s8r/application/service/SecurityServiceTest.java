...
class SecurityServiceTest {
    ...
    @Mock
    private SecurityPort securityPortMock;

    @Mock
    private LoggerPort loggerMock;

    @Mock
    private AuthenticationContext authContextMock;
    ...
    void testInitializeFailure() {
        // Setup
        when(securityPortMock.initialize()).thenReturn(SecurityResult.failure("Failed", "Initialization error"));
    ...
    void testLoginSuccess() {
        // Setup
        when(securityPortMock.authenticate("user", "password")).thenReturn(SecurityResult.success("Authenticated"));
    ...
    void testLoginFailure() {
        // Setup
        when(securityPortMock.authenticate("user", "wrong")).thenReturn(SecurityResult.failure("Failed", "Invalid credentials"));
    ...
    void testShutdownFailure() {
        // Setup
        when(securityPortMock.shutdown()).thenReturn(SecurityResult.failure("Failed", "Shutdown error"));
