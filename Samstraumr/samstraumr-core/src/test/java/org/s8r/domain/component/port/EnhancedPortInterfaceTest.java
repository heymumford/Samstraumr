 ...
 * 
 * <p>This test demonstrates how port interfaces enable Clean Architecture
 * by allowing high-level modules to depend on abstractions.</p>
 */
@UnitTest
public class EnhancedPortInterfaceTest {
    ...
    private static class TestCompositeComponentPort extends TestComponentPort implements CompositeComponentPort {
    ...
    private static class MachineService {
        ...
        public void connectMachineComposites(ComponentId machineId, String sourceComposite, String targetComposite) {
            repository.findById(machineId).ifPresent(
                machine -> machine.connectComposites(sourceComposite, targetComposite));
        }
    }
    ...
    void testDomainEntitiesWithPortInterfaces() {
        ...
        CompositeComponent domainComposite = CompositeFactory.createComposite(
            CompositeType.STANDARD, "Domain Composite");
        ...
        Machine domainMachine = MachineFactory.createMachine(
