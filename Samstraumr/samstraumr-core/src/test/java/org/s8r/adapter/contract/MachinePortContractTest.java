 ...
 * 
 * <p>This test class verifies that any implementation of the MachinePort
 ...
 * implementation.</p>
 * 
 * <p>The tests cover core functionality such as state transitions, component
 * management, and composite connections.</p>
 */
public class MachinePortContractTest extends PortContractTest<MachinePort> {
    ...
    protected MachinePort createPortImplementation() {
        ...
        return machineFactoryAdapter.createMachine(MachineType.STANDARD, "test-machine");
    }
    ...
    public void nullInputHandlingTests() {
        ...
        assertFalse(portUnderTest.addComposite(null, mock(CompositeComponentPort.class)),
                "Adding composite with null name should return false");
        
        // Test null component in addComponent
        assertFalse(portUnderTest.addComposite("test-component", null),
                "Adding null composite should return false");
        
        // Test null name in removeComponent
        assertTrue(portUnderTest.removeComposite(null).isEmpty(),
                "Removing composite with null name should return empty Optional");
        
        // Test null name in getComponent
        assertNull(portUnderTest.getComposite(null),
                "Getting composite with null name should return null");
        
        // Test null source/target names in connect
        assertFalse(portUnderTest.connectComposites(null, "target"),
                "Connecting with null source should return false");
        assertFalse(portUnderTest.connectComposites("source", null),
    ...
    public void basicMachineIdentityTests() {
        ...
        assertEquals(MachineType.STANDARD, portUnderTest.getMachineType(), "Machine type should match");
        assertEquals(MachineState.STOPPED, portUnderTest.getMachineState(), "Initial state should be STOPPED");
    }
    ...
    public void stateTransitionTests() {
        ...
        assertEquals(MachineState.ERROR, portUnderTest.getMachineState(), 
    ...
    public void compositeManagementTests() {
        ...
        // Add composites
        assertTrue(portUnderTest.addComposite("comp1", mockComposite1), 
                "Adding composite should succeed");
        assertTrue(portUnderTest.addComposite("comp2", mockComposite2), 
                "Adding second composite should succeed");
        
        // Get composite by name
        assertEquals(mockComposite1, portUnderTest.getComposite("comp1"), 
    ...
    public void compositeConnectionTests() {
        ...
        // Connect composites
        assertTrue(portUnderTest.connectComposites("comp1", "comp2"), 
                "Connecting composites should succeed");
        ...
        assertTrue(connections.get("comp1").contains("comp2"), 
                "Connection should link source to target");
        
        // Connection with non-existent composite should fail
        assertFalse(portUnderTest.connectComposites("comp1", "nonexistent"), 
                "Connecting to non-existent composite should fail");
        assertFalse(portUnderTest.connectComposites("nonexistent", "comp2"), 
    ...
    private class MockCompositeComponentPort implements CompositeComponentPort {
        ...
        @Override public ComponentId getId() { return null; }
        @Override public List<String> getLineage() { return null; }
        @Override public List<String> getActivityLog() { return null; }
        @Override public java.time.Instant getCreationTime() { return null; }
        @Override public List<org.s8r.domain.event.DomainEvent> getDomainEvents() { return null; }
        @Override public void addToLineage(String entry) {}
        @Override public void clearEvents() {}
        @Override public void publishData(String channel, Map<String, Object> data) {}
        @Override public void publishData(String channel, String key, Object value) {}
        @Override public void transitionTo(org.s8r.domain.lifecycle.LifecycleState newState) {}
        @Override public void activate() {}
        @Override public void deactivate() {}
        @Override public void terminate() {}
        @Override public org.s8r.domain.lifecycle.LifecycleState getLifecycleState() { return null; }
        @Override public boolean addComponent(String name, ComponentPort component) { return false; }
        @Override public Optional<ComponentPort> removeComponent(String name) { return Optional.empty(); }
        @Override public ComponentPort getComponent(String name) { return null; }
        @Override public boolean hasComponent(String name) { return false; }
        @Override public Map<String, ComponentPort> getComponents() { return new HashMap<>(); }
        @Override public boolean connect(String sourceName, String targetName) { return false; }
        @Override public boolean disconnect(String sourceName, String targetName) { return false; }
        @Override public Map<String, List<String>> getConnections() { return new HashMap<>(); }
        @Override public List<String> getConnectionsFrom(String sourceName) { return null; }
    }
