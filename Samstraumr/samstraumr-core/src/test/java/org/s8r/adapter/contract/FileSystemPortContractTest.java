 ...
 * 
 * <p>This test class verifies that any implementation of the FileSystemPort
...
public class FileSystemPortContractTest extends PortContractTest<FileSystemPort> {
    ...
    public void setUpTestFiles() {
        ...
        FileResult dirResult = portUnderTest.createDirectory(testDirectory);
        assertTrue(dirResult.isSuccessful(), "Failed to create test directory: " + dirResult.getMessage());
        
        // Create a test file with some content
        String testContent = "This is a test file for FileSystemPort contract tests.";
        FileResult fileResult = portUnderTest.writeString(testFile, testContent, StandardCharsets.UTF_8, false);
    ...
    public void nullInputHandlingTests() {
        ...
        FileResult nullDirResult = portUnderTest.createDirectory(null);
        assertFalse(nullDirResult.isSuccessful(), "createDirectory(null) should return failure result");
        
        // Test null content in writeString
        FileResult nullContentResult = portUnderTest.writeString(testFile, null, StandardCharsets.UTF_8, false);
        assertFalse(nullContentResult.isSuccessful(), "writeString(path, null) should return failure result");
    ...
    public void fileCreationAndExistenceTests() {
        ...
        assertTrue(portUnderTest.exists(testDirectory), "exists() should return true for existing directory");
        assertTrue(portUnderTest.exists(testFile), "exists() should return true for existing file");
        assertFalse(portUnderTest.exists(nonExistentPath), "exists() should return false for non-existent path");
        
        // Test creating a new directory
        String newDir = testDirectory + "/new-dir";
        FileResult dirResult = portUnderTest.createDirectory(newDir);
        ...
        assertTrue(portUnderTest.exists(deepDir), "Deep directory structure should exist after creation");
    }
    ...
    public void fileContentTests() {
        ...
        FileResult writeResult = portUnderTest.writeString(testFile, testContent, StandardCharsets.UTF_8, false);
        ...
        assertEquals(testContent, readResult.getAttributes().get("content"), "Read content should match written content");
        
        // Test writing and reading lines
        List<String> lines = List.of("Line 1", "Line 2", "Line 3");
        FileResult writeLinesResult = portUnderTest.writeLines(testFile, lines, StandardCharsets.UTF_8, false);
    ...
    public void fileOperationsTests() {
        ...
        assertFalse(portUnderTest.exists(copiedFile), "Original file should no longer exist after move");
        
        // Test directory copy
        String subDir = testDirectory + "/sub-dir";
        portUnderTest.createDirectory(subDir);
        portUnderTest.writeString(subDir + "/sub-file.txt", "Sub-directory file content", StandardCharsets.UTF_8, false);
        ...
        assertTrue(portUnderTest.exists(copiedDir + "/sub-file.txt"), "Files in copied directory should exist");
        ...
        assertFalse(portUnderTest.exists(copiedDir), "Directory should no longer exist after recursive delete");
    }
    ...
    public void fileListingAndSearchingTests() {
        ...
        portUnderTest.createDirectory(testDirectory + "/list-test");
        portUnderTest.writeString(testDirectory + "/file1.txt", "File 1", StandardCharsets.UTF_8, false);
        portUnderTest.writeString(testDirectory + "/file2.txt", "File 2", StandardCharsets.UTF_8, false);
        portUnderTest.writeString(testDirectory + "/list-test/nested.txt", "Nested file", StandardCharsets.UTF_8, false);
        ...
        FileResult searchResult = portUnderTest.search(testDirectory, "*.txt", SearchMode.CURRENT_DIRECTORY);
        ...
        FileResult recursiveSearchResult = portUnderTest.search(testDirectory, "*.txt", SearchMode.RECURSIVE);
        assertTrue(recursiveSearchResult.isSuccessful(), "recursive search() should succeed");
        
        @SuppressWarnings("unchecked")
        List<FileInfo> recursiveSearchFiles = (List<FileInfo>) recursiveSearchResult.getAttributes().get("files");
    ...
    public void pathManipulationTests() {
        ...
        String unnormalizedPath = testDirectory + "/../" + testDirectory.substring(testDirectory.lastIndexOf('/') + 1);
    ...
    public void streamOperationsTests() {
        ...
        OutputStream outputStream = (OutputStream) outputStreamResult.getAttributes().get("outputStream");
