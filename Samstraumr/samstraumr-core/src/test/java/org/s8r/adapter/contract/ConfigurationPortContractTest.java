 ...
 * 
 * <p>This test class verifies that any implementation of the ConfigurationPort
 ...
 * implementation.</p>
 * 
 * <p>The tests cover operations for retrieving configuration values of various types,
 * including default values and string lists.</p>
 */
public class ConfigurationPortContractTest extends PortContractTest<ConfigurationPort> {
    ...
    protected ConfigurationPort createPortImplementation() {
        ...
        return new ConfigurationAdapter(mockConfiguration, logger);
    }
    ...
    public void nullInputHandlingTests() {
        ...
        assertEquals("default", nullStringDefaultResult, "getString(null, default) should return default value");
        ...
        assertEquals(defaultList, nullListDefaultResult, "getStringList(null, default) should return default value");
    ...
    public void stringValueTests() {
        ...
        assertTrue(existingValue.isPresent(), "getString() should return present Optional for existing key");
        ...
        assertTrue(nonExistentValue.isEmpty(), "getString() should return empty Optional for non-existent key");
        
        // Test getting an existing string value with default
        String existingWithDefault = portUnderTest.getString("string.key", "default");
        assertEquals("string value", existingWithDefault, "getString() with default should return actual value when key exists");
        ...
        assertEquals("default", nonExistentWithDefault, "getString() with default should return default value when key doesn't exist");
    }
    ...
    public void integerValueTests() {
        ...
        assertTrue(existingValue.isPresent(), "getInt() should return present Optional for existing key");
        ...
        assertTrue(nonExistentValue.isEmpty(), "getInt() should return empty Optional for non-existent key");
        
        // Test getting an invalid integer value
        Optional<Integer> invalidValue = portUnderTest.getInt("string.key");
        assertTrue(invalidValue.isEmpty(), "getInt() should return empty Optional for invalid integer format");
        
        // Test getting an existing integer value with default
        int existingWithDefault = portUnderTest.getInt("int.key", 100);
        assertEquals(42, existingWithDefault, "getInt() with default should return actual value when key exists");
        ...
        assertEquals(100, nonExistentWithDefault, "getInt() with default should return default value when key doesn't exist");
    }
    ...
    public void booleanValueTests() {
        ...
        assertTrue(trueValue.isPresent(), "getBoolean() should return present Optional for existing key");
        ...
        assertTrue(falseValue.isPresent(), "getBoolean() should return present Optional for existing key");
        ...
        assertTrue(nonExistentValue.isEmpty(), "getBoolean() should return empty Optional for non-existent key");
        
        // Test getting an existing boolean value with default
        boolean trueWithDefault = portUnderTest.getBoolean("bool.key.true", false);
        assertTrue(trueWithDefault, "getBoolean() with default should return actual value when key exists");
        ...
        assertTrue(nonExistentWithDefault, "getBoolean() with default should return default value when key doesn't exist");
    }
    ...
    public void stringListTests() {
        ...
        assertTrue(existingList.isPresent(), "getStringList() should return present Optional for existing key");
        assertEquals(3, existingList.get().size(), "getStringList() should return correct number of items");
        assertEquals("item1", existingList.get().get(0), "getStringList() should return correct first item");
        assertEquals("item2", existingList.get().get(1), "getStringList() should return correct second item");
        assertEquals("item3", existingList.get().get(2), "getStringList() should return correct third item");
        
        // Test getting an empty string list
        Optional<List<String>> emptyList = portUnderTest.getStringList("empty.list.key");
        assertTrue(emptyList.isPresent(), "getStringList() should return present Optional for empty list");
        assertTrue(emptyList.get().isEmpty(), "getStringList() should return empty list for empty value");
        
        // Test getting a non-existent string list
        Optional<List<String>> nonExistentList = portUnderTest.getStringList("nonexistent.key");
        assertTrue(nonExistentList.isEmpty(), "getStringList() should return empty Optional for non-existent key");
        ...
        assertEquals(3, existingWithDefault.size(), "getStringList() with default should return actual value when key exists");
        
        // Test getting a non-existent string list with default
        List<String> nonExistentWithDefault = portUnderTest.getStringList("nonexistent.key", defaultList);
        assertEquals(defaultList, nonExistentWithDefault, "getStringList() with default should return default value when key doesn't exist");
    }
    ...
    public void subsetTests() {
        ...
        assertEquals("value1", subset.get("prefix.key1"), "getSubset() should return correct value for first key");
        assertEquals("value2", subset.get("prefix.key2"), "getSubset() should return correct value for second key");
        
        // Test getting a non-existent configuration subset
        Map<String, String> nonExistentSubset = portUnderTest.getSubset("nonexistent.");
        assertTrue(nonExistentSubset.isEmpty(), "getSubset() should return empty map for non-existent prefix");
    }
    ...
    public void keyExistenceTests() {
        ...
        assertFalse(portUnderTest.hasKey("nonexistent.key"), "hasKey() should return false for non-existent key");
    }
