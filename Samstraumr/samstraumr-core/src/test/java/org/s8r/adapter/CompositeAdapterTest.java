 ...
 * <p>
 * These tests verify that the CompositeAdapter correctly bridges between the legacy
 * Tube-based composites and the new Component-based composites.
 */
@UnitTest
public class CompositeAdapterTest {
    ...
    public void testTubeCompositeToComponentComposite() {
        ...
        org.s8r.tube.composite.Composite tubeComposite = new org.s8r.tube.composite.Composite("test-composite", env);
    ...
    public void testWrapTubeComposite() {
        // Create a tube composite with tubes
        Environment env = new Environment();
        org.s8r.tube.composite.Composite tubeComposite = new org.s8r.tube.composite.Composite("wrapped-composite", env);
    ...
    public void testAddTubeToComponentComposite() {
        ...
        Environment env = new Environment();
        org.s8r.tube.composite.Composite tubeComposite = new org.s8r.tube.composite.Composite("source-composite", env);
        ...
        // Transfer the tube
        adapter.addTubeToComponentComposite(tubeComposite, "source-tube", componentComposite, "target-component");
