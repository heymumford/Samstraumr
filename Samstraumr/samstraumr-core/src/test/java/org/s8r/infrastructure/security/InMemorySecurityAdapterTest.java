...
class InMemorySecurityAdapterTest {
    ...
    void testAuthenticateSuccess() {
        ...
        // Verify user context
        Optional<SecurityPort.AuthenticationContext> authContext = securityAdapter.getCurrentAuthContext();
    ...
    void testAuthenticateFailure() {
        ...
        assertTrue(result.getReason().isPresent(), "Reason should be present for failed authentication");
        assertEquals("Invalid username or password", result.getReason().get(), "Reason should indicate invalid credentials");
    }
    ...
    void testLogout() {
        ...
        assertFalse(securityAdapter.getCurrentAuthContext().isPresent(), "No auth context should be present after logout");
    }
    ...
    void testTokenLifecycle() {
        ...
        assertTrue(securityAdapter.getCurrentAuthContext().isPresent(), "Auth context should be present after token auth");
        ...
        assertTrue(failedAuthResult.getReason().isPresent(), "Reason should be present for failed authentication");
        assertEquals("Token has been revoked", failedAuthResult.getReason().get(), "Reason should indicate token revoked");
    }

    @Test
    void testUserRegistrationAndRoleManagement() {
        // Register a new user
        SecurityResult registerResult = securityAdapter.registerUser("testuser", "password123", Set.of("USER"));
        ...
        SecurityResult updateResult = securityAdapter.updateUserRoles(userId, Set.of("USER", "MANAGER"));
    ...
    void testComponentAccess() {
        ...
        SecurityResult accessResult = securityAdapter.checkComponentAccess("component1", "resourceA", "READ");
        ...
        SecurityResult deniedResult = securityAdapter.checkComponentAccess("component1", "resourceC", "READ");
        ...
        SecurityResult writeResult = securityAdapter.checkComponentAccess("component2", "resourceA", "WRITE");
        ...
        SecurityResult unknownResult = securityAdapter.checkComponentAccess("unknown", "resourceA", "READ");
    ...
    void testSecurityEventLogging() {
        ...
        // Get the audit log
        List<Map<String, Object>> logs = securityAdapter.getSecurityAuditLog(
    ...
    void testPermissionChecking() {
        ...
        assertTrue(securityAdapter.hasAllPermissions("READ", "WRITE"), "Admin should have all specified permissions");
        assertTrue(securityAdapter.hasAnyPermission("READ", "NONEXISTENT"), "Admin should have at least one of the specified permissions");
        
        // Check for non-existent permission
        assertFalse(securityAdapter.hasPermission("NONEXISTENT"), "Admin should not have NONEXISTENT permission");
    }
    ...
    void testRoleChecking() {
        ...
        assertTrue(securityAdapter.hasAnyRole("ADMIN", "NONEXISTENT"), "User should have at least one of the specified roles");
        assertFalse(securityAdapter.hasAllRoles("ADMIN", "NONEXISTENT"), "User should not have all specified roles");
    ...
    void testShutdown() {
        ...
        assertFalse(securityAdapter.getCurrentAuthContext().isPresent(), "Auth context should be cleared after shutdown");
