...
public class ValidationAdapterTest {
    ...
    void testValidateAllowedValues() {
        // Test valid value
        ValidationResult validResult = adapter.validateAllowedValues("test", "a", List.of("a", "b", "c"));
        assertTrue(validResult.isValid());
        
        // Test invalid value
        ValidationResult invalidResult = adapter.validateAllowedValues("test", "d", List.of("a", "b", "c"));
        assertFalse(invalidResult.isValid());
        assertEquals(1, invalidResult.getErrors().size());
        
        // Test null value
        ValidationResult nullResult = adapter.validateAllowedValues("test", null, List.of("a", "b", "c"));
        assertFalse(nullResult.isValid());
        assertEquals(1, nullResult.getErrors().size());
