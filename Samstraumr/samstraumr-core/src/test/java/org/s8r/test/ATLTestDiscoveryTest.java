 ...
 *
 * <p>This test is deliberately annotated with @ATL to ensure it gets discovered and executed by
 * the RunATLTests runner. It serves as a verification that the ATL test discovery mechanism
 * is working properly.
 */
@ATL
