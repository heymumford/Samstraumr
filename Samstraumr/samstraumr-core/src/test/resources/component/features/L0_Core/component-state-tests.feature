...
Feature: Component State Management
  ...
  @ATL @L0_Core @Lifecycle @State @Transitions
  ...
  @ATL @L0_Core @Lifecycle @State @Termination
  ...
  @ATL @L0_Core @Lifecycle @State @StateQuery
  ...
  @ATL @L0_Core @Lifecycle @State @InvalidTransition
  ...
  @ATL @L0_Core @Lifecycle @State @TerminationTimer
