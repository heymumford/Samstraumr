...
Feature: Composite Component Connectivity
  ...
  @ATL @L1_Composite @Connectivity @Connection
  ...
  @ATL @L1_Composite @Connectivity @Transformer
  ...
  @ATL @L1_Composite @Connectivity @Validator
  ...
  @ATL @L1_Composite @Connectivity @CircuitBreaker
  ...
  @ATL @L1_Composite @Connectivity @Observer
