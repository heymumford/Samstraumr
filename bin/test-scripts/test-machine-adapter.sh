...
# This script manually tests the MachineAdapter implementation
# It outputs test results to the console, allowing verification of adapter functionality
# without running the full test suite

set -e

echo "======== Testing MachineAdapter functionality ========"
echo "Compiling..."

cd /home/emumford/NativeLinuxProjects/Samstraumr
mkdir -p test-temp
cat > test-temp/MachineAdapterTester.java << 'EOF'
/*
 * Copyright (c) 2025 Eric C. Mumford (@heymumford)
 *
 * This software was developed with analytical assistance from AI tools 
