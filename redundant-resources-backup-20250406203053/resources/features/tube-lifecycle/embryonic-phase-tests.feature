...
@Functional @StructuralIdentity @ConnectionPoints @Positive @Embryonic @L0_Tube @Structure
...
@Functional @StructuralIdentity @InternalStructure @Positive @Embryonic @L0_Tube @Structure
...
@StructuralIdentity @ErrorHandling @Negative @Embryonic @L0_Tube @Structure @Resilience
